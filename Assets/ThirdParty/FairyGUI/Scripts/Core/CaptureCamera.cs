    ...
    public class CaptureCamera : MonoBehaviour {
        ...
        public static int layer {
            get {
                if (_layer == -1) {
                    ...
                    if (_layer == -1) {
                        _layer = 30;
                        Debug.LogWarning("Please define two layers named '" + CaptureCamera.LayerName + "' and '" +
                                         CaptureCamera.HiddenLayerName + "'");
                    }
                }
        ...
        public static RenderTexture CreateRenderTexture(int width, int height, bool stencilSupport) {
            RenderTexture texture =
                new RenderTexture(width, height, stencilSupport ? 24 : 0, RenderTextureFormat.ARGB32);
