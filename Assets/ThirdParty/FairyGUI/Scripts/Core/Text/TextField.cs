        ...
        public void OnPopulateMesh(VertexBuffer vb) {
            ...
            for (int i = 0; i < lineCount; ++i) {
                                    ...
                                    if (!lineClipped) {
                                        ...
                                        if (_textDirection == RTLSupport.DirectionType.UNKNOW)
                                            ...
                                            lineWidth = underlineStart - (clipping
                                                ...
                                                : posx);
                                        if (lineWidth > 0)
                                            _font.DrawLine(vb, underlineStart < posx ? underlineStart : posx,
                                                -(line.y + line.baseline), lineWidth, maxFontSize, 0);
                                    }
                                    ...
                                    if (!lineClipped) {
                                        ...
                                        if (_textDirection == RTLSupport.DirectionType.UNKNOW)
                                            ...
                                            lineWidth = strikethroughStart - (clipping
                                                ...
                                                : posx);
                                        if (lineWidth > 0)
                                            _font.DrawLine(vb, strikethroughStart < posx ? strikethroughStart : posx,
                                                -(line.y + line.baseline), lineWidth, minFontSize, 1);
                                    }
                ...
                if (!lineClipped) {
                    if (format.underline) {
                        ...
                        if (lineWidth > 0)
                            _font.DrawLine(vb, underlineStart < posx ? underlineStart : posx, -(line.y + line.baseline),
                                lineWidth, maxFontSize, 0);
                    }
            ...
            if (_font.customOutline) {
                if (_textFormat.outline != 0)
                    vb.GenerateOutline(UIConfig.enhancedTextOutlineEffect ? 8 : 4, _textFormat.outline,
                        _textFormat.outlineColor);
