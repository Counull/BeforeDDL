    ...
    public class GRPCExampleTestController : MonoBehaviour {
        ...
        private class UnaryGrpcTestCall : GrpcTestCall {
            ...
            public UnaryGrpcTestCall(GRPCExampleLogger log, GrpcTestCallIdFactory callIdFactory, char factoryId,
                HelloWorldService.HelloWorldServiceClient client, Metadata metadata, string detail) : base(log,
                callIdFactory, factoryId,
        ...
        private class ServerStreamingGrpcTestCall : GrpcTestCall {
            public ServerStreamingGrpcTestCall(GRPCExampleLogger log, GrpcTestCallIdFactory callIdFactory,
                char factoryId,
                HelloWorldService.HelloWorldServiceClient client, Metadata metadata) : base(log, callIdFactory,
                factoryId, true, client, metadata) { }
        ...
        private class ClientStreamingGrpcTestCall : GrpcTestCall {
            public ClientStreamingGrpcTestCall(GRPCExampleLogger log, GrpcTestCallIdFactory callIdFactory,
                char factoryId,
                HelloWorldService.HelloWorldServiceClient client, Metadata metadata) : base(log, callIdFactory,
                factoryId, false, client, metadata) { }
        ...
        private class GrpcTestCallIdFactory {
            private static Color Hex2Color(string hex) =>
                ColorUtility.TryParseHtmlString(hex, out var color) ? color : Color.red;
        ...
        void OnGUI() {
            ...
            m_CallFactoryA.ServerAddressInput = GUI.TextField(new Rect(pad, pad, screenWidth * 0.25f, 20),
                m_CallFactoryA.ServerAddressInput, 400);
            m_CallFactoryB.ServerAddressInput =
                GUI.TextField(new Rect(pad + screenWidth * 0.25f, pad, screenWidth * 0.25f, 20),
                    m_CallFactoryB.ServerAddressInput, 400);
