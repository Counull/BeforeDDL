    ...
    public class PlayMakerWelcomeWindow : EditorWindow {
        ...
        private static void DoFailedUnityVersionDialog() {
            EditorUtility.DisplayDialog("PlayMaker",
                ...
                "\n\nPlease re-download and import PlayMaker in the Asset Store to get the correct package for this version of Unity.",
                "OK");
        }
        ...
        public void OnGUI() {
            ...
            EditorStartupPrefs.ShowWelcomeScreen =
                GUILayout.Toggle(EditorStartupPrefs.ShowWelcomeScreen, "Show At Startup");
        ...
        public static void DoBackupHelpBox() {
            ...
            HelpBox(
                "New versions of PlayMaker may include files previously available on the Ecosystem or the forums. " +
                "Use the Pre-Update Check before installing to check for duplicate files. " +
