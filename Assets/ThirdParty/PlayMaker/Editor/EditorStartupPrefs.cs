...
namespace HutongGames.PlayMakerEditor {
    ...
    public class EditorStartupPrefs : ScriptableObject {
        ...
        public static string PlaymakerVersion {
            ...
            private set {
                Instance.playmakerVersion = value;
                Save();
            }
        }
        ...
        public static string WelcomeScreenVersion {
            ...
            set {
                Instance.welcomeScreenVersion = value;
                Save();
            }
        }
        ...
        public static bool UseLegacyNetworking {
            ...
            set {
                instance.useLegacyNetworking = value;
                Save();
            }
        }
        ...
        [SerializeField]
        private string welcomeScreenVersion;
        ...
        private static string GetProjectSignature() {
            return Application.unityVersion + "__" + Application.dataPath + "__" +
                   GetInformationalVersion(Assembly.GetExecutingAssembly());
            ;
        }
