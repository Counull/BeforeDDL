...
namespace HutongGames.PlayMakerEditor {
    ...
    public class PreUpdateChecker : EditorWindow {
        ...
        public readonly Dictionary<string, List<ActionConflict>> actionConflicts =
            new Dictionary<string, List<ActionConflict>>();
        ...
        public void OnEnable() {
            ...
            var titleText = string.Format("Pre-Update Check: PlayMaker {0}",
                PlayMakerWelcomeWindow.InstallCurrentVersion);
