...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class SetBoolValue : FsmStateAction {
        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Bool Variable to set.")]
        public FsmBool boolVariable;

        [RequiredField] [Tooltip("Value to set it to: Check to set to True, Uncheck to set to False.")]
