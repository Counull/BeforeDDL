...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class IntClamp : FsmStateAction {
        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("The variable to clamp.")]
        public FsmInt intVariable;

        [RequiredField] [Tooltip("Minimum allowed value.")]
        public FsmInt minValue;

        [RequiredField] [Tooltip("Maximum allowed value.")]
