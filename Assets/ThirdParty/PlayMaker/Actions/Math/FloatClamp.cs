...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class FloatClamp : FsmStateAction {
        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Float variable to clamp.")]
        public FsmFloat floatVariable;

        [RequiredField] [Tooltip("The minimum value allowed.")]
        public FsmFloat minValue;

        [RequiredField] [Tooltip("The maximum value allowed.")]
