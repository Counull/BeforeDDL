...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class RandomInt : FsmStateAction {
        [RequiredField] [Tooltip("Minimum value for the random number.")]
        public FsmInt min;

        [RequiredField] [Tooltip("Maximum value for the random number.")]
        public FsmInt max;

        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Store the result in an Integer variable.")]
