...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class SelectRandomFloat : FsmStateAction {
        [CompoundArray("Floats", "Float", "Weight")] [Tooltip("A possible float choice.")]
        ...
        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Store the selected float in a Float Variable.")]
