...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class ScreenPick2d : FsmStateAction {
        ...
        [UIHint(UIHint.Variable)] [Tooltip("Store whether the Screen pick did pick a GameObject")]
        public FsmBool storeDidPickObject;

        [UIHint(UIHint.Variable)] [Tooltip("Store the picked GameObject")]
        public FsmGameObject storeGameObject;

        [UIHint(UIHint.Variable)] [Tooltip("Store the picked position in world Space")]
