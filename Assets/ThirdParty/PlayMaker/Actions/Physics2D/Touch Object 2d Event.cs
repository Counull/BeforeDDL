...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class TouchObject2dEvent : FsmStateAction {
        [RequiredField] [CheckForComponent(typeof(Collider2D))] [Tooltip("The Game Object to detect touches on.")]
        ...
        [UIHint(UIHint.Variable)] [Tooltip("Store the 2d position where the object was touched.")]
            ...
            if (touchCount > 0)
            {
                ...
                foreach (var touch in Touchscreen.current.touches)
                {
                    ...
                    if (fingerId.IsNone || touchId == fingerId.Value)
                    {
                        ...
                        var hitInfo =
 Physics2D.GetRayIntersection(Camera.main.ScreenPointToRay(screenPos), Mathf.Infinity);
