...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class RayCast2d : FsmStateAction {
        ...
        [Tooltip(
            "Only include objects with a Z coordinate (depth) greater than this value. Leave as None for no filtering.")]
        public FsmInt minDepth;

        [Tooltip(
            "Only include objects with a Z coordinate (depth) less than this value. Leave as none for no filtering.")]
        ...
        [UIHint(UIHint.Variable)] [Tooltip("Get the 2d position of the ray hit point and store it in a variable.")]
        ...
        private void DoRaycast() {
            ...
            if (minDepth.IsNone && maxDepth.IsNone) {
                hitInfo = Physics2D.Raycast(originPos, dirVector2, rayLength,
