...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetCollision2dInfo : FsmStateAction {
        ...
        [Tooltip(
            "Get the enabled state collision. if false, collision had no effect, like when using the PlatformEffector2D component set to one way")]
        ...
        void StoreCollisionInfo() {
            ...
            physics2dMaterialName.Value = Fsm.Collision2DInfo.collider.sharedMaterial != null
                ? Fsm.Collision2DInfo.collider.sharedMaterial.name
                : "";
