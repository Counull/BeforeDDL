...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetNextOverlapArea2d : FsmStateAction {
        ...
        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Store the next collider in a GameObject variable.")]
        ...
        private Collider2D[] GetOverlapAreaAll() {
            ...
            if (minDepth.IsNone && maxDepth.IsNone) {
                return Physics2D.OverlapAreaAll(firstCornerPos, secondCornerPos,
