...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class SetTextureScale : ComponentAction<Renderer> {
        ...
        [Tooltip(
            "The named texture. See unity docs: <a href=\"http://unity3d.com/support/documentation/ScriptReference/Material.SetTextureScale.html\" rel=\"nofollow\">SetTextureScale</a>")]
        public FsmString namedTexture;

        [RequiredField] [Tooltip("Scale in X axis. 2 = double the texture's width.")]
        public FsmFloat scaleX;

        [RequiredField] [Tooltip("Scale in Y axis. 2 = double the texture's height.")]
        ...
        void DoSetTextureScale() {
            ...
            if (materialIndex.Value == 0) {
                ...
                materials[materialIndex.Value]
                    .SetTextureScale(namedTexture.Value, new Vector2(scaleX.Value, scaleY.Value));
