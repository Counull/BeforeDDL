...
*/
        ...
        [UIHint(UIHint.Variable)] [Tooltip("Store the acceleration in a Vector3 Variable.")]
        public FsmVector3 storeVector;

        [UIHint(UIHint.Variable)] [Tooltip("Store the x component of the acceleration in a Float Variable.")]
        public FsmFloat storeX;

        [UIHint(UIHint.Variable)] [Tooltip("Store the y component of the acceleration in a Float Variable.")]
        public FsmFloat storeY;

        [UIHint(UIHint.Variable)] [Tooltip("Store the z component of the acceleration in a Float Variable.")]
