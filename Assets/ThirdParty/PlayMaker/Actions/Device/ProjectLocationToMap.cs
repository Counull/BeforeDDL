...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class ProjectLocationToMap : FsmStateAction {
        ...
        [Tooltip(
            "Location vector in degrees longitude and latitude. Typically returned by the {{Get Location Info}} action.")]
        ...
        [HasFloatSlider(-180, 180)] [Tooltip("The maximum Longitude show on the map.")]
        public FsmFloat maxLongitude;

        [HasFloatSlider(-90, 90)] [Tooltip("The minimum Latitude shown on the map.")]
        public FsmFloat minLatitude;

        [HasFloatSlider(-90, 90)] [Tooltip("The maximum Latitude shown on the map.")]
