...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetAtan2FromVector3 : FsmStateAction {
        ...
        [RequiredField] [Tooltip("The vector3 definition of the tan")]
        public FsmVector3 vector3;

        [RequiredField] [Tooltip("which axis in the vector3 to use as the x value of the tan")]
        public aTan2EnumAxis xAxis;

        [RequiredField] [Tooltip("which axis in the vector3 to use as the y value of the tan")]
