...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetCosine : FsmStateAction {
        [RequiredField] [Tooltip("The angle. Note: Check Deg To Rad if the angle is expressed in degrees.")]
        public FsmFloat angle;

        [Tooltip("Check if the angle is expressed in degrees.")]
        public FsmBool DegToRad;

        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("The angle cosine.")]
