...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class SetColorRGBA : FsmStateAction {
        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("The Color Variable to set.")]
        public FsmColor colorVariable;

        [HasFloatSlider(0, 1)] [Tooltip("Set the red channel of the color variable.")]
        public FsmFloat red;

        [HasFloatSlider(0, 1)] [Tooltip("Set the green channel of the color variable.")]
        public FsmFloat green;

        [HasFloatSlider(0, 1)] [Tooltip("Set the blue channel of the color variable.")]
        public FsmFloat blue;

        [HasFloatSlider(0, 1)] [Tooltip("Set the alpha channel of the color variable.")]
