...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class ColorInterpolate : FsmStateAction {
        [RequiredField] [Tooltip("An array of colors. Set the number of colors, then set each color.")]
        public FsmColor[] colors;

        [RequiredField] [Tooltip("How long it should take to interpolate through all the colors in the array.")]
