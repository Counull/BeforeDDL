...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class SelectRandomColor : FsmStateAction {
        [CompoundArray("Colors", "Color", "Weight")] [Tooltip("A possible Color choice.")]
        ...
        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Store the selected Color in a Color Variable.")]
