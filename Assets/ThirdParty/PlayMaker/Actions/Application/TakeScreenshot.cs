...
namespace HutongGames.PlayMaker.Actions {
    ...
    [Tooltip(
        "Saves a Screenshot. NOTE: Does nothing in Web Player. On Android, the resulting screenshot is available some time later.")]
    public class TakeScreenshot : FsmStateAction {
        ...
        [RequiredField] [Tooltip("The filename for the screenshot.")]
