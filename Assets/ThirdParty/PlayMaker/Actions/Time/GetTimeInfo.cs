...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetTimeInfo : FsmStateAction {
        ...
        [Tooltip("Info to get.")] public TimeInfo getInfo;

        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Store the time info in a float variable.")]
        ...
        public override string AutoName() {
            return string.Format("GetTimeInfo{0} {1} > {2}", ActionHelpers.colon, getInfo,
                ActionHelpers.GetValueLabel(storeValue));
        }
#endif
    }
}