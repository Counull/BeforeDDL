...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class ArrayContains : FsmStateAction {
        ...
        [RequiredField] [MatchElementType("array")] [Tooltip("The value to check against in the array.")]
        public FsmVar value;

        [ActionSection("Result")] [Tooltip("The index of the value in the array.")] [UIHint(UIHint.Variable)]
        public FsmInt index;

        [Tooltip("Store in a bool whether it contains that element or not.")] [UIHint(UIHint.Variable)]
