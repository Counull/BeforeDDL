...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetFsmArray : BaseFsmVariableAction {
        ...
        [RequiredField] [UIHint(UIHint.FsmArray)] [Tooltip("The name of the FSM variable.")]
        public FsmString variableName;

        [RequiredField] [Tooltip("Get the content of the array variable.")] [UIHint(UIHint.Variable)]
        ...
        private void DoSetFsmArrayCopy() {
            ...
            if (fsmArray != null) {
                if (fsmArray.ElementType != storeValue.ElementType) {
                    LogError("Can only copy arrays with the same elements type. Found <" + fsmArray.ElementType +
                             "> and <" + storeValue.ElementType + ">");
                    return;
                }
