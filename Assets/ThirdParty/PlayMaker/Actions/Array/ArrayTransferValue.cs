...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class ArrayTransferValue : FsmStateAction {
        ...
        [ActionSection("Transfer Options")] [ObjectType(typeof(ArrayTransferType))] [Tooltip("Copy Options.")]
        public FsmEnum copyType;

        [ObjectType(typeof(ArrayPasteType))] [Tooltip("Paste Options")]
        public FsmEnum pasteType;

        [ActionSection("Result")] [Tooltip("Event sent if the array source does not contains that element.")]
