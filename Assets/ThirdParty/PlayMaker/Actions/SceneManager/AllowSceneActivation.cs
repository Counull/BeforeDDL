...
namespace HutongGames.PlayMaker.Actions {
    ...
    [Tooltip(
        "Allow scenes to be activated. Use this after {{LoadSceneAsynch}} if you did not set the scene to activate after loading")]
    public class AllowSceneActivation : FsmStateAction {
        ...
        void DoAllowSceneActivation() {
            ...
            LoadSceneAsynch.aSyncOperationLUT[aSynchOperationHashCode.Value].allowSceneActivation =
