...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class SetActiveScene : FsmStateAction {
        ...
        [Tooltip(
            "The name of the scene to activate. The given sceneName can either be the last part of the path, without .unity extension or the full path still without the .unity extension")]
        ...
        [Tooltip("The scene Path.")] public FsmString sceneByPath;

        [Tooltip("The GameObject scene to activate.")]
        public FsmOwnerDefault sceneByGameObject;


        [ActionSection("Result")] [Tooltip("True if set active succeeded.")] [UIHint(UIHint.Variable)]
        public FsmBool success;

        [Tooltip("Event sent if setActive succeeded.")]
        public FsmEvent successEvent;

        [Tooltip("True if SceneReference resolves to a scene.")] [UIHint(UIHint.Variable)]
        public FsmBool sceneFound;

        [Tooltip("Event sent if scene not activated yet.")] [UIHint(UIHint.Variable)]
