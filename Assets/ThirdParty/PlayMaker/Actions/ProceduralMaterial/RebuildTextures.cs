...
namespace HutongGames.PlayMaker.Actions {
    ...
    [Tooltip(
        "Rebuilds all dirty textures. By default the rebuild is spread over multiple frames so it won't halt the game. Check Immediately to rebuild all textures in a single frame.")]
#if UNITY_2017_3_OR_NEWER
#pragma warning disable 0618
    [Obsolete(
        "Built-in support for Substance Designer materials has been deprecated and will be removed in Unity 2018.1. " +
    ...
    public class RebuildTextures : FsmStateAction {
        ...
        [RequiredField] [Tooltip("Rebuild now!")]
