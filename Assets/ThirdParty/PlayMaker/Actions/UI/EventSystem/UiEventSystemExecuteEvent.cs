...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class UiEventSystemExecuteEvent : FsmStateAction {
        ...
        [RequiredField] [Tooltip("The GameObject with  an IEventSystemHandler component (a UI button for example).")]
        public FsmOwnerDefault gameObject;

        [Tooltip("The Type of handler to execute")] [ObjectType(typeof(EventHandlers))]
        ...
        [Tooltip(
            "Event Sent if execution was NOT possible on GameObject because it can not handle the eventHandler selected")]
        ...
        private bool ExecuteEvent() {
            ...
            switch (handlerType) {
                ...
                case EventHandlers.initializePotentialDrag:
                    ...
                    ExecuteEvents.Execute(go, new BaseEventData(EventSystem.current),
