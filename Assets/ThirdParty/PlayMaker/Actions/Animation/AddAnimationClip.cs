...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class AddAnimationClip : FsmStateAction {
        ...
        [RequiredField] [Tooltip("Optionally give the animation a new name. Can be used by other Animation actions.")]
        public FsmString animationName;

        [ActionSection("Trimming")] [Tooltip("Optionally trim the animation by specifying a first and last frame.")]
