...
namespace HutongGames.PlayMaker.Actions {
    ...
    [Tooltip(
        "Sets the Speed of an Animation. Check Every Frame to update the animation time continuously, e.g., if you're manipulating a variable that controls animation speed.")]
    public class SetAnimationSpeed : BaseAnimationAction {
        ...
        public override void OnEnter() {
            DoSetAnimationSpeed(gameObject.OwnerOption == OwnerDefaultOption.UseOwner
                ? Owner
