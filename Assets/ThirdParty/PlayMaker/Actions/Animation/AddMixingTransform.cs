...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class AddMixingTransform : BaseAnimationAction {
        ...
        [RequiredField]
        [Tooltip(
            "The name of the animation to mix. NOTE: The animation should already be added to the Animation Component on the GameObject.")]
        public FsmString animationName;

        [RequiredField] [Tooltip("The mixing transform. E.g., root/upper_body/left_shoulder")]
