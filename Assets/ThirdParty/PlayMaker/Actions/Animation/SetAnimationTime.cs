...
namespace HutongGames.PlayMaker.Actions {
    ...
    [Tooltip(
        "Sets the current Time of an Animation. Useful for manually controlling playback of an animation. Check Every Frame to update the time continuously.")]
    public class SetAnimationTime : BaseAnimationAction {
        ...
        public override void OnEnter() {
            DoSetAnimationTime(gameObject.OwnerOption == OwnerDefaultOption.UseOwner
                ? Owner
