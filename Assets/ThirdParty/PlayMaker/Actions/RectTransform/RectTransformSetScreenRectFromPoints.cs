...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class RectTransformSetScreenRectFromPoints : BaseUpdateAction {
        ...
        [RequiredField] [Tooltip("The screen position of the first point to define the rect.")]
        public FsmVector2 point1;

        [RequiredField] [Tooltip("The screen position of the second point to define the rect.")]
        public FsmVector2 point2;

        [Tooltip("Screen points use normalized coordinates (0-1).")]
        public FsmBool normalized;

        [UIHint(UIHint.Variable)] [Tooltip("Store the resulting screen rect.")]
        ...
        private void DoSetValues() {
            ...
            RectTransformUtility.ScreenPointToLocalPointInRectangle(rootRectTransform, screenPoint, canvasCamera,
                out localPosition);
