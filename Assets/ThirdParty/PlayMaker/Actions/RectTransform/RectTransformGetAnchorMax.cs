...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class RectTransformGetAnchorMax : BaseUpdateAction {
        ...
        [Tooltip("The anchorMax")] [UIHint(UIHint.Variable)]
        public FsmVector2 anchorMax;

        [Tooltip("The x component of the anchorMax")] [UIHint(UIHint.Variable)]
        public FsmFloat x;

        [Tooltip("The y component of the anchorMax")] [UIHint(UIHint.Variable)]
        public FsmFloat y;
