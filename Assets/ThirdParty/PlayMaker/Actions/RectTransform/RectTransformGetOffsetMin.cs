...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class RectTransformGetOffsetMin : BaseUpdateAction {
        ...
        [Tooltip("The offsetMin")] [UIHint(UIHint.Variable)]
        public FsmVector2 offsetMin;

        [Tooltip("The x component of the offsetMin")] [UIHint(UIHint.Variable)]
        public FsmFloat x;

        [Tooltip("The y component of the offsetMin")] [UIHint(UIHint.Variable)]
        public FsmFloat y;
