...
namespace HutongGames.PlayMaker.Actions {
    ...
    [Tooltip(
        "The position ( normalized or not) in the parent RectTransform keeping the anchor rect size intact. This lets you position the whole Rect in one go. Use this to easily animate movement (like IOS sliding UIView)")]
    public class RectTransformSetAnchorRectPosition : BaseUpdateAction {
        ...
        [HasFloatSlider(0f, 1f)] [Tooltip("Anchor X position.")]
        public FsmFloat x;

        [HasFloatSlider(0f, 1f)] [Tooltip("Anchor Y position.")]
        public FsmFloat y;
