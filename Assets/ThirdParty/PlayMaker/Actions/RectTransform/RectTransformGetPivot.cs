...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class RectTransformGetPivot : BaseUpdateAction {
        ...
        [Tooltip("The pivot")] [UIHint(UIHint.Variable)]
        public FsmVector2 pivot;

        [Tooltip("The x component of the pivot")] [UIHint(UIHint.Variable)]
        public FsmFloat x;

        [Tooltip("The y component of the pivot")] [UIHint(UIHint.Variable)]
        public FsmFloat y;
