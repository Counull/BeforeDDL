...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class RectTransformGetOffsetMax : BaseUpdateAction {
        ...
        [Tooltip("The offsetMax")] [UIHint(UIHint.Variable)]
        public FsmVector2 offsetMax;

        [Tooltip("The x component of the offsetMax")] [UIHint(UIHint.Variable)]
        public FsmFloat x;

        [Tooltip("The y component of the offsetMax")] [UIHint(UIHint.Variable)]
        public FsmFloat y;
