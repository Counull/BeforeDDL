...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class ScreenWrap : ComponentAction<Transform, Camera> {
        [RequiredField] [Tooltip("The GameObject to wrap.")]
        public FsmOwnerDefault gameObject;

        [CheckForComponent(typeof(Camera))]
        [Tooltip(
            "GameObject with a Camera component used to render the view (or MainCamera if not set). The Viewport Rect is used for wrapping.")]
