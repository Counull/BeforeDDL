...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class ScreenToWorldPoint : FsmStateAction {
        ...
        [Tooltip(
            "If true, X/Y coordinates are considered normalized (0-1), otherwise they are expected to be in pixels")]
        public FsmBool normalized;

        [UIHint(UIHint.Variable)] [Tooltip("Store the world position in a vector3 variable.")]
