...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class ClampOrthographicView : ComponentAction<Camera> {
        ...
        [RequiredField] [Tooltip("The GameObject with a Camera component.")]
        public FsmOwnerDefault gameObject;

        [Tooltip("Orientation of the view.")] public ScreenPlane view;
        ...
        [Tooltip(
            "Perform in LateUpdate. This is useful if you want to clamp the position of objects that are animated or otherwise positioned in Update.")]
