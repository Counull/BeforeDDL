...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class MouseLook2 : ComponentAction<Rigidbody> {
        ...
        [RequiredField] [Tooltip("Speed around X axis. Higher = faster.")]
        public FsmFloat sensitivityX;

        [RequiredField] [Tooltip("Speed around Y axis. Higher = faster.")]
        public FsmFloat sensitivityY;

        [RequiredField] [HasFloatSlider(-360, 360)] [Tooltip("Minimum angle around X axis.")]
        public FsmFloat minimumX;

        [RequiredField] [HasFloatSlider(-360, 360)] [Tooltip("Maximum angle around X axis.")]
        public FsmFloat maximumX;

        [RequiredField] [HasFloatSlider(-360, 360)] [Tooltip("Minimum angle around Y axis.")]
