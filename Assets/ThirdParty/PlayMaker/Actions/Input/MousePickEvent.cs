...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class MousePickEvent : FsmStateAction {
        [CheckForComponent(typeof(Collider))] [Tooltip("The game object to test for mouse picking.")]
        ...
        private bool DoRaycast() {
            var testObject = GameObject.OwnerOption == OwnerDefaultOption.UseOwner
                ? Owner
                : GameObject.GameObject.Value;

            // ActionHelpers uses a cache to try and minimize Raycasts

            return ActionHelpers.IsMouseOver(testObject, rayDistance.Value,
