...
namespace HutongGames.PlayMaker.Actions {
    ...
    [Tooltip(
        "Sends an Event when the specified Mouse Button is released. Optionally store the button state in a bool variable.")]
    public class GetMouseButtonUp : FsmStateAction {
        ...
        [UIHint(UIHint.Variable)] [Tooltip("Store the pressed state in a Bool Variable.")]
