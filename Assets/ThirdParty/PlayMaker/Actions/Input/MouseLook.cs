...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class MouseLook : ComponentAction<Transform> {
        ...
        [RequiredField] [Tooltip("Sensitivity of movement in X direction.")]
        public FsmFloat sensitivityX;

        [RequiredField] [Tooltip("Sensitivity of movement in Y direction.")]
        ...
        private void DoMouseLook() {
            ...
            switch (axes) {
                ...
                case RotationAxes.MouseX:
                    ...
                    cachedTransform.localEulerAngles =
                        new Vector3(cachedTransform.localEulerAngles.x, GetXRotation(), 0);
                    break;

                case RotationAxes.MouseY:

                    cachedTransform.localEulerAngles =
                        new Vector3(GetYRotation(-1), cachedTransform.localEulerAngles.y, 0);
                    break;
            }
        }
