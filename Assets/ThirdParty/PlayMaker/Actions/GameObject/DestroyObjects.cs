...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class DestroyObjects : FsmStateAction {
        [RequiredField] [ArrayEditor(VariableType.GameObject)] [Tooltip("The GameObjects to destroy.")]
        public FsmArray gameObjects;

        [HasFloatSlider(0, 5)] [Tooltip("Optional delay before destroying the Game Objects.")]
