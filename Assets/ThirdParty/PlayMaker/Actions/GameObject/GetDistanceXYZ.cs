...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetDistanceXYZ : ComponentAction<Transform> {
        [RequiredField] [Tooltip("Measure distance from this GameObject.")]
        ...
        [UIHint(UIHint.Variable)] [Tooltip("Store the distance in a float variable.")]
        public FsmFloat storeDistance;

        [Tooltip(
            "Space used to measure the distance in. E.g. along the world X axis or the GameObject's local X axis.")]
        public Space space;

        [UIHint(UIHint.Variable)] [Tooltip("Store the distance along the X axis.")]
        public FsmFloat storeXDistance;

        [UIHint(UIHint.Variable)] [Tooltip("Store the distance along the Y axis.")]
        public FsmFloat storeYDistance;

        [UIHint(UIHint.Variable)] [Tooltip("Store the distance along the Z axis.")]
