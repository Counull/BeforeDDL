...
namespace HutongGames.PlayMaker.Actions {
    ...
    [Tooltip(
        "Gets info on the last Character Controller collision event. The owner of the FSM must have a character controller. " +
    ...
    public class GetControllerHitInfo : FsmStateAction {
        ...
        [Tooltip(
            "Store the physics material of the Game Object Hit. Useful for triggering different effects. Audio, particles...")]
