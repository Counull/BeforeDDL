...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class ControllerJump : ComponentAction<CharacterController> {
        ...
        [Tooltip("How high to jump.")] public FsmFloat jumpHeight;
        ...
        [UIHint(UIHint.Variable)] [Tooltip("Store how fast the Character Controlling was moving when it landed.")]
        public FsmFloat landingSpeed;

        [UIHint(UIHint.Variable)] [Tooltip("Store the last movement before landing.")]
