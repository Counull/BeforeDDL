...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class ControllerCrouch : ComponentAction<CharacterController> {
        ...
        [RequiredField] [Tooltip("Height of capsule when crouching.")]
        ...
        [RequiredField] [Tooltip("How long it takes to crouch/stand in seconds.")]
        ...
        [UIHint(UIHint.Variable)] [Tooltip("Try to stand if true. Useful if want to toggle crouch with a button.")]
            ...
            switch (crouchState) {
                ...
                case CrouchState.standToCrouch:
                    ...
                    if (transitionTimeElapsed < transitionTime.Value) {
                        newHeight = Mathf.Lerp(startTransitionHeight, crouchHeight.Value,
                            transitionTimeElapsed / transitionTime.Value);
                ...
                case CrouchState.crouchToStand:
                    ...
                    if (transitionTimeElapsed < transitionTime.Value) {
                        newHeight = Mathf.Lerp(startTransitionHeight, originalHeight,
                            transitionTimeElapsed / transitionTime.Value);
                        transitionTimeElapsed += Time.deltaTime;
                    }
                    else {
