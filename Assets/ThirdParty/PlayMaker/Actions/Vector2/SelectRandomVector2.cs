...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class SelectRandomVector2 : FsmStateAction {
        [CompoundArray("Vectors", "Vector", "Weight")] [Tooltip("A possible Vector2 choice.")]
        ...
        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Store the selected Vector2 in a Vector2 Variable.")]
