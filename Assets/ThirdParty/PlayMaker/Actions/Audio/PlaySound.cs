...
namespace HutongGames.PlayMaker.Actions {
    ...
    [Tooltip(
        "Plays an Audio Clip at a position defined by a Game Object or Vector3. If a position is defined, it takes priority over the game object. This action doesn't require an Audio Source component, but offers less control than Audio actions.")]
    public class PlaySound : FsmStateAction {
        ...
        [RequiredField] [Title("Audio Clip")] [ObjectType(typeof(AudioClip))] [Tooltip("The audio clip to play.")]
        public FsmObject clip;

        [HasFloatSlider(0, 1)] [Tooltip("Volume to play sound at.")]
