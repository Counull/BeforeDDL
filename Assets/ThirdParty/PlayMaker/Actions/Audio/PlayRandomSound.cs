...
namespace HutongGames.PlayMaker.Actions {
    ...
    [Tooltip(
        "Plays a Random Audio Clip at a position defined by a Game Object or a Vector3. If a position is defined, it takes priority over the game object. You can set the relative weight of the clips to control how often they are selected.")]
    public class PlayRandomSound : FsmStateAction {
        ...
        [HasFloatSlider(0, 1)] [Tooltip("Volume to play the sound at.")]
