...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class Flicker : ComponentAction<Renderer> {
        ...
        [HasFloatSlider(0, 1)] [Tooltip("The frequency of the flicker in seconds.")]
        public FsmFloat frequency;

        [HasFloatSlider(0, 1)] [Tooltip("Amount of time flicker is On (0-1). E.g. Use 0.95 for an occasional flicker.")]
