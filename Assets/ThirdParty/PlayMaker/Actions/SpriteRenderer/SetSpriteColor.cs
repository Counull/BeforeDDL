...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class SetSpriteColor : ComponentAction<SpriteRenderer> {
        ...
        [HasFloatSlider(0, 1)] [Tooltip("Set the red channel")]
        public FsmFloat red;

        [HasFloatSlider(0, 1)] [Tooltip("Set the green channel")]
        public FsmFloat green;

        [HasFloatSlider(0, 1)] [Tooltip("Set the blue channel")]
        public FsmFloat blue;

        [HasFloatSlider(0, 1)] [Tooltip("Set the alpha channel")]
