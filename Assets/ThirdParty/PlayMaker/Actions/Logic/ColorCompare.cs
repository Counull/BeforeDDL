...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class ColorCompare : FsmStateAction {
        [RequiredField] [Tooltip("The first Color.")]
        public FsmColor color1;

        [RequiredField] [Tooltip("The second Color.")]
        public FsmColor color2;

        [RequiredField]
        [Tooltip(
            "Tolerance of test, to test for 'almost equals' or to ignore small floating point rounding differences.")]
        ...
        [Tooltip(
            "Repeat every frame. Useful if the variables are changing and you're waiting for a particular result.")]
