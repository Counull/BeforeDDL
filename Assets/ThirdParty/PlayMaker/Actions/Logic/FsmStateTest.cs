...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class FsmStateTest : FsmStateAction {
        ...
        [RequiredField] [Tooltip("Check to see if the FSM is in this state.")]
        ...
        [Tooltip(
            "Repeat every frame. Useful if you want to wait for an FSM to be in a particular state before sending an event.")]
