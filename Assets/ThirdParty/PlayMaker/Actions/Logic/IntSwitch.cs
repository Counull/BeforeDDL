...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class IntSwitch : FsmStateAction {
        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("The integer variable to test.")]
        public FsmInt intVariable;

        [CompoundArray("Int Switches", "Compare Int", "Send Event")] [Tooltip("The integer variable to test.")]
        public FsmInt[] compareTo;

        [Tooltip("Event to send if true.")] public FsmEvent[] sendEvent;
