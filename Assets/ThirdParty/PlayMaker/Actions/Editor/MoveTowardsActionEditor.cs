            ...
            if (moveTowardsAction.UpdateTargetPos()) {
                ...
                if (!moveTowardsAction.targetPosition.IsNone) {
                    if (goTarget != null) {
                        ...
                        moveTowardsAction.targetPosition.Value =
                            goTargetTransform.InverseTransformPoint(Handles.PositionHandle(worldTargetPos,
                        ...
                        moveTowardsAction.targetPosition.Value =
                            Handles.PositionHandle(moveTowardsAction.targetPosition.Value, Quaternion.identity);
                    }
                }
                ...
                Handles.ConeHandleCap(0, goPosition + lookAtVector.normalized * (distance - arrowSize * 0.7f),
                    lookAtRotation, arrowSize, EventType.Repaint); // fudge factor to position cap correctly
#else
