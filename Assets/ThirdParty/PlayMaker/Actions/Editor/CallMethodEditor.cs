    ...
    public class CallMethodEditor : CustomActionEditor {
        ...
        private void CheckCache() {
            if (callMethod.behaviour != null) {
                ...
                if (callMethod.behaviour.Value != null &&
                    callMethod.behaviour.Value.GetType() != callMethod.behaviour.ObjectType) {
        ...
        public override bool OnGUI() {
            ...
            if (cachedMethod != null && cachedMethod.ReturnType != typeof(void)) {
                ...
                callMethod.storeResult =
                    FsmEditor.ActionEditor.EditFsmVar(cachedReturnLabel, callMethod.storeResult, returnAttributes);
            }
        ...
        private string GetMethodSignatureFromSettings() {
            if (callMethod.methodName == null || callMethod.parameters == null ||
                callMethod.storeResult == null) return "";
            return TypeHelpers.GetMethodSignature(callMethod.methodName.Value, callMethod.parameters,
                callMethod.storeResult);
        }
