...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class SendMessage : FsmStateAction {
        ...
        [RequiredField] [Tooltip("The Game Object to send a message to.")]
        ...
        [Tooltip(
            "Message delivery options. See <a href=\"http://unity3d.com/support/documentation/ScriptReference/SendMessageOptions.html\" rel=\"nofollow\">SendMessageOptions</a> in Unity Docs.")]
        public SendMessageOptions options;

        [RequiredField] [Tooltip("Select a Method Name first then Parameters.")]
