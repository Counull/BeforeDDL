...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class FindOverlaps : ComponentAction<Transform> {
        ...
        [HideIf("HideRadius")] [Tooltip("Radius of sphere/capsule.")]
        public FsmFloat radius;

        [HideIf("HideBox")] [Tooltip("Size of box.")]
        public FsmVector3 box;

        [HideIf("HideCapsule")] [Tooltip("The height of the capsule.")]
        ...
        private void DoGetOverlap() {
            ...
            switch (shape) {
                case Shape.Box:
                    overlapCount =
                        Physics.OverlapBoxNonAlloc(center, box.Value / 2f, colliders, orientation, targetMask);
                    break;
                ...
                case Shape.Capsule:
                    overlapCount = Physics.OverlapCapsuleNonAlloc(capsulePoint1, capsulePoint2, radius.Value, colliders,
                        targetMask);
                    break;
            }
