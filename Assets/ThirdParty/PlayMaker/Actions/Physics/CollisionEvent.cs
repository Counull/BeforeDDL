...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class CollisionEvent : FsmStateAction {
        ...
        [UIHint(UIHint.TagMenu)] [Tooltip("Tags to collide with.")]
        public FsmString collideTag;

        [Tooltip("Event to send if a collision is detected.")]
        public FsmEvent sendEvent;

        [UIHint(UIHint.Variable)] [Tooltip("Store the Game Object collided with in a {{Game Object Variable}}.")]
        public FsmGameObject storeCollider;

        [UIHint(UIHint.Variable)]
        [Tooltip(
            "Store the force of the collision. NOTE: Use Get Collision Info to get more info about the collision.")]
