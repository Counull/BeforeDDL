...
namespace HutongGames.PlayMaker.Actions {
    ...
    [Tooltip(
        "Check the current State name on a specified layer, this is more than the layer name, it holds the current state as well.")]
    public class GetAnimatorCurrentStateInfoIsName : FsmStateActionAnimatorBase {
        ...
        [ActionSection("Results")] [UIHint(UIHint.Variable)] [Tooltip("True if name matches")]
