...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetAnimatorIKGoal : FsmStateActionAnimatorBase {
        ...
        [Tooltip("The IK goal")] [ObjectType(typeof(AvatarIKGoal))]
        ...
        [UIHint(UIHint.Variable)]
        [Tooltip(
            "Gets The position of the ik goal. If Goal GameObject is defined, position is used as an offset from Goal")]
