...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class SetAnimatorLookAt : ComponentAction<Animator> {
        ...
        [Tooltip(
            "The look-at position. If Target GameObject is set, this is used as an offset from the Target's position.")]
        ...
        [HasFloatSlider(0f, 1f)] [Tooltip("Determines how much the body is involved in the LookAt. Range from 0 to 1")]
        public FsmFloat bodyWeight;

        [HasFloatSlider(0f, 1f)] [Tooltip("Determines how much the head is involved in the LookAt. Range from 0 to 1")]
        public FsmFloat headWeight;

        [HasFloatSlider(0f, 1f)] [Tooltip("Determines how much the eyes are involved in the LookAt. Range from 0 to 1")]
