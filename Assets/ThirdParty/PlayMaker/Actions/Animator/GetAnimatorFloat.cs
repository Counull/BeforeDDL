...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetAnimatorFloat : FsmStateActionAnimatorBase {
        ...
        [RequiredField] [UIHint(UIHint.AnimatorFloat)] [Tooltip("The animator parameter")]
        public FsmString parameter;

        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("The float value of the animator parameter")]
