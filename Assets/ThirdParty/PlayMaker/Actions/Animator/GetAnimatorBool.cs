...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetAnimatorBool : FsmStateActionAnimatorBase {
        ...
        [RequiredField] [UIHint(UIHint.AnimatorBool)] [Tooltip("The animator parameter")]
        public FsmString parameter;

        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("The bool value of the animator parameter")]
