...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetAnimatorCurrentStateInfoIsTag : FsmStateActionAnimatorBase {
        ...
        [ActionSection("Results")] [UIHint(UIHint.Variable)] [Tooltip("True if tag matches")]
        public FsmBool tagMatch;

        [Tooltip("Event send if tag matches")] public FsmEvent tagMatchEvent;

        [Tooltip("Event send if tag matches")] public FsmEvent tagDoNotMatchEvent;
