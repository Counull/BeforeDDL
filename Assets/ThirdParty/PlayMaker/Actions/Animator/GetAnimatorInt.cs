...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetAnimatorInt : FsmStateActionAnimatorBase {
        ...
        [RequiredField] [UIHint(UIHint.AnimatorInt)] [Tooltip("The animator parameter")]
        public FsmString parameter;

        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("The int value of the animator parameter")]
