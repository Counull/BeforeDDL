...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class SelectRandomString : FsmStateAction {
        [CompoundArray("Strings", "String", "Weight")] [Tooltip("A possible String choice.")]
        ...
        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Store the chosen String in a String Variable.")]
