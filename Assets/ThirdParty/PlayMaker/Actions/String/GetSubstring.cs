...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetSubstring : FsmStateAction {
        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("The string to get characters from.")]
        public FsmString stringVariable;

        [RequiredField] [Tooltip("The start of the substring (0 = first character).")]
        public FsmInt startIndex;

        [RequiredField] [Tooltip("The number of characters to get.")]
        public FsmInt length;

        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Store the result in a string variable.")]
