...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class StringReplace : FsmStateAction {
        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("The String Variable to examine.")]
        public FsmString stringVariable;

        [Tooltip("Replace this string...")] public FsmString replace;
        [Tooltip("... with this string.")] public FsmString with;
