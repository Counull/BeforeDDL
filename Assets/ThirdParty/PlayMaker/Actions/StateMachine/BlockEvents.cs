...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class BlockEvents : FsmStateAction {
        ...
        [Tooltip("When to block events.")] public Options condition;
        ...
        [EventNotSent] [Tooltip("Context sensitive parameter. Depends on Condition.")]
        public FsmEvent eventParam;

        [ActionSection("Debug")] [Tooltip("Log any events blocked by this action. Helpful for debugging.")]
