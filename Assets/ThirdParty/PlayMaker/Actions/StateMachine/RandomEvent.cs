...
namespace HutongGames.PlayMaker.Actions {
    ...
    [Tooltip(
        "Sends a Random State Event after an optional delay. Use this to transition to a random state connected to the current state.")]
    public class RandomEvent : FsmStateAction {
        [HasFloatSlider(0, 10)] [Tooltip("Delay before sending the event (seconds).")]
