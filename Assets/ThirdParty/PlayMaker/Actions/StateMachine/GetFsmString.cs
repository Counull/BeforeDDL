...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetFsmString : FsmStateAction {
        ...
        [RequiredField] [UIHint(UIHint.FsmString)] [Tooltip("The name of the FSM variable to get.")]
        public FsmString variableName;

        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Store the value in a String variable in this FSM.")]
