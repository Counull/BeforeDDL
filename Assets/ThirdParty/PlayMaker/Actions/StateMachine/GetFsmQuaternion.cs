...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetFsmQuaternion : FsmStateAction {
        ...
        [RequiredField] [UIHint(UIHint.FsmQuaternion)] [Tooltip("The name of the FSM variable to get.")]
        public FsmString variableName;

        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Store the value in a Quaternion variable in this FSM.")]
