...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetFsmEnum : FsmStateAction {
        ...
        [RequiredField] [UIHint(UIHint.FsmEnum)] [Tooltip("The name of the FSM variable to get.")]
        public FsmString variableName;

        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Store the value in an Enum variable in this FSM.")]
