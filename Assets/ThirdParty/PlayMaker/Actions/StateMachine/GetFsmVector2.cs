...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetFsmVector2 : FsmStateAction {
        ...
        [RequiredField] [UIHint(UIHint.FsmVector2)] [Tooltip("The name of the FSM variable to get.")]
        public FsmString variableName;

        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Store the value in a Vector2 variable in this FSM.")]
