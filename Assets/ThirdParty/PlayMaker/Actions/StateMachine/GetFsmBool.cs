...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetFsmBool : FsmStateAction {
        ...
        [RequiredField] [UIHint(UIHint.FsmBool)] [Tooltip("The name of the FSM variable to get.")]
        public FsmString variableName;

        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Store the value in a Bool variable in this FSM.")]
