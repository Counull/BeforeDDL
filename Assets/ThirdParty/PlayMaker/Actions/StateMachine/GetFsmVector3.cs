...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetFsmVector3 : FsmStateAction {
        ...
        [RequiredField] [UIHint(UIHint.FsmVector3)] [Tooltip("The name of the FSM variable to get.")]
        public FsmString variableName;

        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Store the value in a Vector3 variable in this FSM.")]
