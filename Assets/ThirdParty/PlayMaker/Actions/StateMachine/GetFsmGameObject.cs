...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetFsmGameObject : FsmStateAction {
        ...
        [RequiredField] [UIHint(UIHint.FsmGameObject)] [Tooltip("The name of the FSM variable to get.")]
        public FsmString variableName;

        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Store the value in a GameObject variable in this FSM.")]
