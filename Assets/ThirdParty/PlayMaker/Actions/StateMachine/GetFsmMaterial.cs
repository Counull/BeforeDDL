...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetFsmMaterial : FsmStateAction {
        ...
        [RequiredField] [UIHint(UIHint.FsmMaterial)] [Tooltip("The name of the FSM variable to get.")]
        public FsmString variableName;

        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Store the value in a Material variable in this FSM.")]
