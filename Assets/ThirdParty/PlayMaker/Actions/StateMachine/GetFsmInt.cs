...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetFsmInt : FsmStateAction {
        ...
        [RequiredField] [UIHint(UIHint.FsmInt)] [Tooltip("The name of the FSM variable to get.")]
        public FsmString variableName;

        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Store the value in an Int variable in this FSM.")]
