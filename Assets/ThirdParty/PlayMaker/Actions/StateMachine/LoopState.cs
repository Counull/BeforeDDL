...
namespace HutongGames.PlayMaker.Actions {
    ...
    [Note(
        "Put this action at the end of a State to loop through all actions in a state the specified number of times.")]
    ...
    public class LoopState : FsmStateAction {
        [RequiredField] [Tooltip("How many times to loop through the state.")]
        public FsmInt loops;
