...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetFsmColor : FsmStateAction {
        ...
        [RequiredField] [UIHint(UIHint.FsmColor)] [Tooltip("The name of the FSM variable to get.")]
        public FsmString variableName;

        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Store the value in a Color variable in this FSM.")]
