...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetFsmFloat : FsmStateAction {
        ...
        [RequiredField] [UIHint(UIHint.FsmFloat)] [Tooltip("The name of the FSM variable to get.")]
        public FsmString variableName;

        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Store the value in a Float variable in this FSM.")]
