...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetFsmRect : FsmStateAction {
        ...
        [RequiredField] [UIHint(UIHint.FsmRect)] [Tooltip("The name of the FSM variable to get.")]
        public FsmString variableName;

        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Store the value in a Rect variable in this FSM.")]
