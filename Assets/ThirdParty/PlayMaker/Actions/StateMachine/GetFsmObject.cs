...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetFsmObject : FsmStateAction {
        ...
        [RequiredField] [UIHint(UIHint.FsmObject)] [Tooltip("The name of the FSM variable to get.")]
        public FsmString variableName;

        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Store the value in an Object variable in this FSM.")]
