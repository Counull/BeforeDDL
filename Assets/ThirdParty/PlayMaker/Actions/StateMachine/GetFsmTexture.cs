...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetFsmTexture : FsmStateAction {
        ...
        [RequiredField] [UIHint(UIHint.FsmTexture)] [Tooltip("The name of the FSM variable to get.")]
        public FsmString variableName;

        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Store the value in a Texture variable in this FSM.")]
