...
namespace HutongGames.PlayMaker.Actions {
    ...
    [Tooltip(
        "Begin a GUILayout area that follows the specified game object. Useful for overlays (e.g., playerName). NOTE: Block must end with a corresponding GUILayoutEndArea.")]
    public class GUILayoutBeginAreaFollowObject : FsmStateAction {
        [RequiredField] [Tooltip("The GameObject to follow.")]
        public FsmGameObject gameObject;

        [RequiredField] [Tooltip("Left screen offset.")]
        public FsmFloat offsetLeft;

        [RequiredField] [Tooltip("Screen offset up.")]
        public FsmFloat offsetTop;

        [RequiredField] [Tooltip("Width of area.")]
        public FsmFloat width;

        [RequiredField] [Tooltip("Height of area.")]
