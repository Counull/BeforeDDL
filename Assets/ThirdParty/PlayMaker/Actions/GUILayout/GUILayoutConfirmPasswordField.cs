...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GUILayoutConfirmPasswordField : GUILayoutAction {
        [UIHint(UIHint.Variable)] [Tooltip("The password Text")]
        public FsmString text;

        [Tooltip("The Maximum Length of the field")]
        public FsmInt maxLength;

        [Tooltip("The Style of the Field")] public FsmString style;
        ...
        [Tooltip("Confirmation content")] public FsmString password;
