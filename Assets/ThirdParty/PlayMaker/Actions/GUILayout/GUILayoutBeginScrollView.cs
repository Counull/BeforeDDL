    ...
    public class GUILayoutBeginScrollView : GUILayoutAction {
        ...
        public override void OnGUI() {
            if (useCustomStyle.Value) {
                scrollPosition.Value = GUILayout.BeginScrollView(scrollPosition.Value, horizontalScrollbar.Value,
                    verticalScrollbar.Value, horizontalStyle.Value, verticalStyle.Value, backgroundStyle.Value,
                    LayoutOptions);
            }
            else {
                scrollPosition.Value = GUILayout.BeginScrollView(scrollPosition.Value, horizontalScrollbar.Value,
                    verticalScrollbar.Value, LayoutOptions);
            }
        }
    }
}