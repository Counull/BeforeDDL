...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class SetRectFromPoints : FsmStateAction {
        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Rectangle to set.")]
        public FsmRect rectangle;

        [Tooltip("First point.")] public FsmVector2 point1;

        [Tooltip("Second point.")] public FsmVector2 point2;

        [Tooltip(
            "Avoid negative width and height values. This is useful for UI rects that don't draw if they have negative dimensions.")]
