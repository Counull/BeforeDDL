...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class SetRectFields : FsmStateAction {
        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Rect Variable to set.")]
        public FsmRect rectVariable;

        [Tooltip("Set X value.")] public FsmFloat x;
        [Tooltip("Set Y value.")] public FsmFloat y;
        [Tooltip("Set Width.")] public FsmFloat width;
        [Tooltip("Set Height.")] public FsmFloat height;
