...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetRotation : FsmStateAction {
        ...
        [UIHint(UIHint.Variable)] [Tooltip("Get the rotation as a Quaternion.")]
        ...
        [UIHint(UIHint.Variable)] [Tooltip("Get the angle around the X axis.")]
        public FsmFloat xAngle;

        [UIHint(UIHint.Variable)] [Tooltip("Get the angle around the Y axis.")]
        public FsmFloat yAngle;

        [UIHint(UIHint.Variable)] [Tooltip("Get the angle around the Z axis.")]
