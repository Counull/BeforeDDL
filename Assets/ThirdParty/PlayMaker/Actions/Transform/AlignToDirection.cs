...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class AlignToDirection : ComponentAction<Transform> {
        ...
        [RequiredField] [Tooltip("The direction to look at. E.g. the Hit Normal from a Raycast.")]
        public FsmVector3 targetDirection;

        [RequiredField] [Tooltip("The GameObject axis to align to the direction.")] [ObjectType(typeof(AlignAxis))]
        public FsmEnum alignAxis;

        [Tooltip("Flip the alignment axis. So x becomes -x.")]
        public FsmBool flipAxis;

        [Tooltip("Repeat every update.")] public bool everyFrame;
        ...
        private void DoAlignToDirection() {
            ...
            cachedTransform.rotation = Quaternion.FromToRotation(alignDirection, targetDirection.Value) *
