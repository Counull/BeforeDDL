...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class MoveTowards : FsmStateAction {
        ...
        [Tooltip(
            "A world position to move towards, if no Target Object is set. Otherwise used as a local offset from the Target Object.")]
        ...
        [HasFloatSlider(0, 20)]
        [Tooltip(
            "The maximum movement speed (Unity units per second). HINT: You can make this a variable to change it over time.")]
        ...
        void DoMoveTowards() {
            ...
            go.transform.position =
                Vector3.MoveTowards(go.transform.position, targetPos, maxSpeed.Value * Time.deltaTime);
