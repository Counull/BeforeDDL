...
namespace HutongGames.PlayMaker.Actions {
    ...
    [Tooltip(
        "Scales the GUI around a pivot point. By default only effects GUI rendered by this FSM, check Apply Globally to effect all GUI controls.")]
    public class ScaleGUI : FsmStateAction {
        [RequiredField] [Tooltip("Scale in x (1 = 100%)")]
        public FsmFloat scaleX;

        [RequiredField] [Tooltip("Scale in y (1 = 100%)")]
        public FsmFloat scaleY;

        [RequiredField] [Tooltip("Scale around this x screen coordinate.")]
        public FsmFloat pivotX;

        [RequiredField] [Tooltip("Scale around this y screen coordinate.")]
