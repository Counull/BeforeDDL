...
namespace HutongGames.PlayMaker.Actions {
    ...
    [Tooltip(
        "Rotates the GUI around a pivot point. By default only effects GUI rendered by this FSM, check Apply Globally to effect all GUI controls.")]
    public class RotateGUI : FsmStateAction {
        [RequiredField] [Tooltip("Angle to rotate in degrees.")]
        public FsmFloat angle;

        [RequiredField] [Tooltip("X coordinate of pivot.")]
        public FsmFloat pivotX;

        [RequiredField] [Tooltip("Y coordinate of pivot.")]
