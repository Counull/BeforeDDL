...
namespace HutongGames.PlayMaker.Actions {
    ...
    [Tooltip(
        "Math expression action. Enter the expression using variable names and common math syntax. Uses Mathos parser.")]
    public class MathExpression : FsmStateAction {
        ...
        [Tooltip("Store the result in a float variable")] [UIHint(UIHint.Variable)]
        public FsmFloat storeResultAsFloat;

        [Tooltip("Store the result in an int variable")] [UIHint(UIHint.Variable)]
