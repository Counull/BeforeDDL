...
namespace HutongGames.PlayMakerEditor {
    ...
    public class TweenPositionEditor : TweenEditorBase {
        ...
        public override void OnSceneGUI() {
            ...
            if (PlayMaker.Actions.TweenHelpers.CanEditTargetPosition(tweenAction.fromOption, tweenAction.fromPosition,
                    tweenAction.fromTarget)) {
                tweenAction.fromPosition.Value = PlayMaker.Actions.TweenHelpers.DoTargetPositionHandle(startPos,
                    tweenAction.fromOption,
                    transform, tweenAction.fromTarget);
            }

            if (PlayMaker.Actions.TweenHelpers.CanEditTargetPosition(tweenAction.toOption, tweenAction.toPosition,
                    tweenAction.toTarget)) {
                tweenAction.toPosition.Value = PlayMaker.Actions.TweenHelpers.DoTargetPositionHandle(endPos,
                    tweenAction.toOption,
