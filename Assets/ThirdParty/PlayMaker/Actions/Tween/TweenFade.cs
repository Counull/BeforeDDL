...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class TweenFade : TweenActionBase {
        private const string SupportedComponents =
            "MeshRenderer, Sprite, Image, Text, Light, AudioSource, or CanvasGroup component.";
        ...
        [Tooltip("Fade To or From value.")] public TweenDirection tweenDirection;
        ...
        public override string AutoName() {
            return "TweenFade: " + ActionHelpers.GetValueLabel(Fsm, gameObject) + " " + tweenDirection + " " +
