...
namespace HutongGames.PlayMaker.Actions {
    public static class TweenHelpers {
        ...
        /// <returns></returns>
        public static Quaternion GetTargetRotation(RotationOptions option, Transform owner, Transform target,
            Vector3 rotation) {
        ...
        private static bool CanEditTargetRotation(RotationOptions option, NamedVariable rotation,
            FsmGameObject target) {
        ...
        private static bool IsValidTargetPosition(PositionOptions option, NamedVariable position,
            FsmGameObject target) {
            switch (option) {
        ...
        public static Vector3 GetTargetPosition(PositionOptions option, Transform owner, Transform target,
            Vector3 position) {
        ...
        public static Vector3 GetUiTargetPosition(UiPositionOptions option, RectTransform owner, Transform target,
            Vector3 position) {
            if (owner == null) return Vector3.zero;
        ...
        public static Vector3 DoTargetPositionHandle(Vector3 worldPos, PositionOptions option, Transform owner,
            FsmGameObject target) {
