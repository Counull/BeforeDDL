...
namespace HutongGames.PlayMaker.Actions {
    ...
    public abstract class TweenActionBase : BaseUpdateAction {
        [ActionSection("Easing")] [Tooltip("Delay before starting the tween.")]
        ...
        [Tooltip("Custom tween curve. Note: Typically you would use the 0-1 range.")] [HideIf("HideCustomCurve")]
        ...
        [Tooltip("Looping options.")] public LoopType loopType;
