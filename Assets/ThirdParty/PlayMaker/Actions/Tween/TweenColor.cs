...
namespace HutongGames.PlayMaker.Actions {
    ...
    [Tooltip(
        "Tween the color of a GameObject or a Color variable. The GameObject needs a Material, Sprite, Image, Text, or Light component.")]
    public class TweenColor : TweenPropertyBase<FsmColor> {
        ...
        [Tooltip("What to tween.")] public Target target = Target.Variable;

        [Tooltip("A GameObject with a Material, Sprite, Image, Text, or Light component.")]
        public FsmOwnerDefault gameObject;

        [Tooltip("The variable to tween.")] [UIHint(UIHint.Variable)]
        public FsmColor variable;

        [Tooltip(OffsetTooltip)] public ColorBlendMode fromOffsetBlendMode;

        [Tooltip(OffsetTooltip)] public ColorBlendMode toOffsetBlendMode;
