...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class TweenPunch : TweenComponentBase<Transform> {
        ...
        [Tooltip("Punch magnitude.")] public FsmVector3 value;
            ...
            switch (punchType) {
                case PunchType.Position:
                    if (rectTransform != null) {
                        rectTransform.anchoredPosition = Vector3.Lerp(startVector3, endVector3,
                            easingFunction(0, 1, normalizedTime));
                    }
                    else {
                        transform.position =
                            Vector3.Lerp(startVector3, endVector3, easingFunction(0, 1, normalizedTime));
                    }
        ...
        public override string AutoName() {
            return "TweenPunch: " + ActionHelpers.GetValueLabel(Fsm, gameObject) + " " + punchType + " " +
