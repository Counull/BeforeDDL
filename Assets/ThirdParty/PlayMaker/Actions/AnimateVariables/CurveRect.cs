...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class CurveRect : CurveFsmAction {
        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("The Rect Variable to animate.")]
        public FsmRect rectVariable;

        [RequiredField] [Tooltip("The Rect to animate from.")]
        public FsmRect fromValue;

        [RequiredField] [Tooltip("The Rect to animate to.")]
        public FsmRect toValue;

        [RequiredField] [Tooltip("Curve that controls the X value.")]
        ...
        [RequiredField] [Tooltip("Curve that controls the Y value.")]
        ...
        [RequiredField] [Tooltip("Curve that controls the Width.")]
        ...
        [RequiredField] [Tooltip("Curve that controls the Height.")]
