...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class EaseVector3 : EaseFsmAction {
        [RequiredField] [Tooltip("The Vector3 value to ease from.")]
        public FsmVector3 fromValue;

        [RequiredField] [Tooltip("The Vector3 value to ease to.")]
        public FsmVector3 toValue;

        [UIHint(UIHint.Variable)] [Tooltip("Store the result in a Vector3 Variable.")]
        ...
        public override void OnUpdate() {
            ...
            if (finishAction && !finishInNextStep) {
                if (!vector3Variable.IsNone) {
                    vector3Variable.Value = new Vector3(
