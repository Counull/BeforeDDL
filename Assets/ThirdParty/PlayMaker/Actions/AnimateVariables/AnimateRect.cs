...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class AnimateRect : AnimateFsmAction {
        ...
        [RequiredField] [Tooltip("Curve to use for the X value.")]
        ...
        [RequiredField] [Tooltip("Curve to use for the Y value.")]
        ...
        [RequiredField] [Tooltip("Curve to use for the Width.")]
        ...
        [RequiredField] [Tooltip("Curve to use for the Height.")]
