...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class DebugDrawShape : ComponentAction<Transform> {
        ...
        [RequiredField] [Tooltip("Draw the Gizmo at a GameObject's position.")]
        public FsmOwnerDefault gameObject;

        [Tooltip("The type of Gizmo to draw:\nSphere, Cube, WireSphere, or WireCube.")]
        public ShapeType shape;

        [Tooltip("The color to use.")] public FsmColor color;

        [HideIf("HideRadius")] [Tooltip("Use this for sphere gizmos")]
        public FsmFloat radius;

        [HideIf("HideSize")] [Tooltip("Use this for cube gizmos")]
