...
namespace HutongGames.PlayMaker.Actions {
    ...
    [Tooltip(
        "Draws a line in the Scene View from a Start point in a direction. Specify the start point as Game Objects or Vector3 world positions. " +
    ...
    public class DrawDebugRay : FsmStateAction {
        ...
        [Tooltip("The color of the ray.")] public FsmColor color;
