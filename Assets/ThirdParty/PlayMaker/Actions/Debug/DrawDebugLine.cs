...
namespace HutongGames.PlayMaker.Actions {
    ...
    [Tooltip(
        "Draws a line from a Start point to an End point. Specify the points as Game Objects or Vector3 world positions. " +
    ...
    public class DrawDebugLine : FsmStateAction {
        ...
        [Tooltip("The color of the line.")] public FsmColor color;
