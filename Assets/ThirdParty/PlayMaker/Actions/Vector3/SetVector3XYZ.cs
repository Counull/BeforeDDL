...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class SetVector3XYZ : FsmStateAction {
        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Vector3 variable to set.")]
        public FsmVector3 vector3Variable;

        [Tooltip("Set using another Vector3 variable and/or individual channels below.")] [UIHint(UIHint.Variable)]
        public FsmVector3 vector3Value;

        [Tooltip("Set X channel.")] public FsmFloat x;
        [Tooltip("Set Y channel.")] public FsmFloat y;
        [Tooltip("Set Z channel.")] public FsmFloat z;
