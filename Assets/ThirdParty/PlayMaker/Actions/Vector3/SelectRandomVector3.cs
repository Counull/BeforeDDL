...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class SelectRandomVector3 : FsmStateAction {
        [CompoundArray("Vectors", "Vector", "Weight")] [Tooltip("A possible Vector3 choice.")]
        ...
        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("Store the selected Vector3 in a Vector3 Variable.")]
