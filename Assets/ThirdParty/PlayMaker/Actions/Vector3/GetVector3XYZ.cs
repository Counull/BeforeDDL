...
namespace HutongGames.PlayMaker.Actions {
    ...
    public class GetVector3XYZ : FsmStateAction {
        [RequiredField] [UIHint(UIHint.Variable)] [Tooltip("The Vector3 variable to examine.")]
        public FsmVector3 vector3Variable;

        [UIHint(UIHint.Variable)] [Tooltip("Store X value in a float variable.")]
        public FsmFloat storeX;

        [UIHint(UIHint.Variable)] [Tooltip("Store Y value in a float variable.")]
        public FsmFloat storeY;

        [UIHint(UIHint.Variable)] [Tooltip("Store Z value in a float variable.")]
