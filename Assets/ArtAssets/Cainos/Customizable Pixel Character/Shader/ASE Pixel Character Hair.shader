    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(VertexOutput IN) : SV_Target
            {
                ...
                float4 color19 = IsGammaSpace()
                           ? float4(0.68, 0.52, 0.4, 1)
                           : float4(0.4200333, 0.233022, 0.1328683, 1);
                ...
                float IsShadow31 = (((tex2DNode7.r - tex2DNode7.g) < 0.01 ? 1.0 : 0.0) * (
                    (tex2DNode7.r - tex2DNode7.b) < 0.01 ? 1.0 : 0.0));
