...
namespace Cainos.CustomizablePixelCharacter {
    public class ProjectileArrow : Projectile {
        [Space]
        [Tooltip(
            "If the angle between arrow direction and hit surface normal is below this angle, the arrow can insert into the surface.")]
        [FoldoutGroup("Params")]
        public float insertMaxAngle = 60.0f;

        [Tooltip("Arrow insert depth when hit.")] [FoldoutGroup("Params")]
