...
namespace Cainos.CustomizablePixelCharacter {
    ...
    public class PixelCharacter : MonoBehaviour {
        ...
        [Space] [FoldoutGroup("Reference")] public Renderer hat;
        ...
        [Space] [FoldoutGroup("Reference")] public Transform rigHead;
        ...
        [Space] [FoldoutGroup("Reference")] public Transform weaponSlot;
        ...
        [SerializeField, HideInInspector] private bool clipHair;
        ...
        [SerializeField, HideInInspector] private bool hideHair;
        ...
        [SerializeField, HideInInspector] private bool shoesInFront;

        //the interval for the character to blink, random between x and y
        [FoldoutGroup("Customization")] public Vector2 blinkInterval = new Vector2(0.5f, 5.0f);
