...
namespace Cainos.PixelArtMonster_Dungeon {
    public class MonsterController : MonoBehaviour {
        ...
        public float
            jumpDelay = 0.5f; // time for the character to actually jump after jump key is pressed down, to make time for the jump prepare animation to be played
        ...
        public Vector2
            groundCheckSize =
                new Vector2(0.1f,
                    0.1f); // size of the box at the character's bottom to determine whether the character is on ground
        ...
        public bool
            canAttackWhenMoving =
                true; // can the character attack when moving? When turned off, it also forbit the character to move while in attack animation
        ...
        private void Update() {
            ...
            pm.MovingBlend =
                Mathf.MoveTowards(pm.MovingBlend, movingBlend, Time.deltaTime * movingBlendTransitionSpeed);
