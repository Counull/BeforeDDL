...
namespace Cainos.PixelArtMonster_Dungeon {
    public class MonsterFlyingController : MonoBehaviour {
        ...
        public float
            deadGravityScale =
                1.0f; // gravity scale when the character is dead. it actually controls whether should the flying character fall to the ground when it is dead, in most case you should set this to either 0.0 or 1.0
        ...
        private void Update() {
            ...
            pm.SpeedVertical =
                Mathf.MoveTowards(pm.SpeedVertical, inputMove.y, Time.deltaTime * movingBlendTransitionSpeed);
