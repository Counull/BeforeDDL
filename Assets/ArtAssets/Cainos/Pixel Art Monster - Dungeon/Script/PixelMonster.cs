...
namespace Cainos.PixelArtMonster_Dungeon {
    public class PixelMonster : MonoBehaviour {
        ...
        [SerializeField, HideInInspector] private int facing = 1;
        ...
        [SerializeField, HideInInspector] private bool isHiding;
        ...
        [SerializeField, HideInInspector] private bool isInJumpPrepare;
        ...
        [SerializeField, HideInInspector] private bool isGrounded;
        ...
        [SerializeField, HideInInspector] private bool isDead;

        //moving animation blend
        //0.0:idle,  0.5:walk,  1.0:run
        [ExposeProperty]
        public float MovingBlend {
            get { return movingBlend; }
            set {
                movingBlend = value;
        ...
        [SerializeField, HideInInspector] private float movingBlend;
