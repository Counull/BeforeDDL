...
namespace Cainos.LucidEditor {
    public static class LucidEditorGUILayout {
        ...
        public static Rect
            GetControlRect(bool hasLabel, float height, GUIStyle style, params GUILayoutOption[] options) =>
        ...
        public static void
            ReadOnlyField(GUIContent label, object value, Type objType, params GUILayoutOption[] options) =>
            LucidEditorGUI.ReadOnlyField(EditorGUILayout.GetControlRect(options), label, value, objType);
        ...
        public static bool PropertyField(SerializedProperty property, bool includeChildren,
            params GUILayoutOption[] options) => EditorGUILayout.PropertyField(property, includeChildren, options);

        public static bool PropertyField(SerializedProperty property, GUIContent label,
            params GUILayoutOption[] options) => EditorGUILayout.PropertyField(property, label, options);
        ...
        public static string
            TextField(GUIContent label, string value, GUIStyle style, params GUILayoutOption[] options) =>
            EditorGUILayout.TextField(label, value, style, options);
        ...
        public static string DelayedTextField(string label, string value, GUIStyle style,
            params GUILayoutOption[] options) => EditorGUILayout.DelayedTextField(label, value, style, options);
        ...
        public static string PasswordField(string label, string password, GUIStyle style,
            params GUILayoutOption[] options) => EditorGUILayout.PasswordField(label, password, style, options);
        ...
        public static int
            DelayedIntField(GUIContent label, int value, GUIStyle style, params GUILayoutOption[] options) =>
            EditorGUILayout.DelayedIntField(label, value, style, options);
        ...
        public static int IntPopup(string label, int selectedValue, string[] displayedOptions, int[] optionValues,
            GUIStyle style, params GUILayoutOption[] options) => EditorGUILayout.IntPopup(label, selectedValue,
            displayedOptions, optionValues, style, options);
        ...
        public static int IntPopup(GUIContent label, int selectedValue, GUIContent[] displayedOptions,
            ...
            EditorGUILayout.IntPopup(label, selectedValue, displayedOptions, optionValues, style, options);
        ...
        public static void IntSlider(SerializedProperty property, int leftValue, int rightValue,
            params GUILayoutOption[] options) => EditorGUILayout.IntSlider(property, leftValue, rightValue, options);
        ...
        public static float
            FloatField(GUIContent label, float value, GUIStyle style, params GUILayoutOption[] options) =>
            EditorGUILayout.FloatField(label, value, style, options);

        public static float FloatSlider(float value, float leftValue, float rightValue,
            params GUILayoutOption[] options) => EditorGUILayout.Slider(value, leftValue, rightValue, options);

        public static float FloatSlider(string label, float value, float leftValue, float rightValue,
            params GUILayoutOption[] options) => EditorGUILayout.Slider(label, value, leftValue, rightValue, options);
        ...
        public static void FloatSlider(SerializedProperty property, float leftValue, float rightValue,
            params GUILayoutOption[] options) => EditorGUILayout.Slider(property, leftValue, rightValue, options);
        ...
        public static float DelayedFloatField(string label, float value, GUIStyle style,
            params GUILayoutOption[] options) => EditorGUILayout.DelayedFloatField(label, value, style, options);
        ...
        public static double
            DoubleField(string label, double value, GUIStyle style, params GUILayoutOption[] options) =>
        ...
        public static double DoubleField(GUIContent label, double value, GUIStyle style,
            params GUILayoutOption[] options) => EditorGUILayout.DoubleField(label, value, style, options);
        ...
        public static double DelayedDoubleField(string label, double value, GUIStyle style,
            params GUILayoutOption[] options) => EditorGUILayout.DelayedDoubleField(label, value, style, options);
        ...
        public static Vector2Int
            Vector2IntField(GUIContent label, Vector2Int value, params GUILayoutOption[] options) =>
            EditorGUILayout.Vector2IntField(label, value, options);
        ...
        public static Vector3Int
            Vector3IntField(GUIContent label, Vector3Int value, params GUILayoutOption[] options) =>
            EditorGUILayout.Vector3IntField(label, value, options);
        ...
        public static Gradient GradientField(GUIContent label, Gradient gradient, bool hdr,
            params GUILayoutOption[] options) => EditorGUILayout.GradientField(label, gradient, hdr, options);
        ...
        public static AnimationCurve CurveField(GUIContent label, AnimationCurve value,
            params GUILayoutOption[] options) => EditorGUILayout.CurveField(label, value, options);

        public static AnimationCurve CurveField(AnimationCurve value, Color color, Rect ranges,
            params GUILayoutOption[] options) => EditorGUILayout.CurveField(value, color, ranges, options);

        public static AnimationCurve CurveField(string label, AnimationCurve value, Color color, Rect ranges,
            params GUILayoutOption[] options) => EditorGUILayout.CurveField(label, value, color, ranges, options);
        ...
        public static void CurveField(SerializedProperty property, Color color, Rect ranges,
            params GUILayoutOption[] options) => EditorGUILayout.CurveField(property, color, ranges, options);

        public static void CurveField(SerializedProperty property, Color color, Rect ranges, GUIContent label,
            params GUILayoutOption[] options) => EditorGUILayout.CurveField(property, color, ranges, label, options);
        ...
        public static Enum EnumFlagsField(string label, Enum enumValue, GUIStyle style,
            params GUILayoutOption[] options) => EditorGUILayout.EnumFlagsField(label, enumValue, style, options);
        ...
        public static TEnum EnumFlagsField<TEnum>(GUIContent label, TEnum enumValue, bool includeObsolete,
            ...
            (TEnum) EditorGUILayout.EnumFlagsField(label, enumValue, includeObsolete, style, options);
        ...
        public static Enum
            EnumPopup(GUIContent label, Enum selected, GUIStyle style, params GUILayoutOption[] options) =>
            EditorGUILayout.EnumPopup(label, selected, style, options);
        ...
        public static Enum EnumPopup(GUIContent label, Enum selected, Func<Enum, bool> checkEnabled,
            ...
            EditorGUILayout.EnumPopup(label, selected, checkEnabled, includeObsolete, style, options);

        public static TEnum EnumPopup<TEnum>(TEnum selected, params GUILayoutOption[] options) where TEnum : Enum =>
            (TEnum) EditorGUILayout.EnumPopup(selected, options);
        ...
        public static TEnum EnumPopup<TEnum>(string label, TEnum selected, GUIStyle style,
            params GUILayoutOption[] options) where TEnum : Enum =>
            (TEnum) EditorGUILayout.EnumPopup(label, selected, style, options);
        ...
        public static TEnum EnumPopup<TEnum>(GUIContent label, TEnum selected, Func<Enum, bool> checkEnabled,
            ...
            (TEnum) EditorGUILayout.EnumPopup(label, selected, checkEnabled, includeObsolete, options);

        public static TEnum EnumPopup<TEnum>(GUIContent label, TEnum selected, Func<Enum, bool> checkEnabled,
            bool includeObsolete, GUIStyle style, params GUILayoutOption[] options) where TEnum : Enum =>
            (TEnum) EditorGUILayout.EnumPopup(label, selected, checkEnabled, includeObsolete, style, options);

        public static Object ObjectField(Object obj, Type objType, bool allowSceneObjects,
            params GUILayoutOption[] options) => EditorGUILayout.ObjectField(obj, objType, allowSceneObjects, options);
        ...
        public static T ObjectField<T>(T obj, bool allowSceneObjects, params GUILayoutOption[] options)
            where T : Object => (T) EditorGUILayout.ObjectField(obj, typeof(T), allowSceneObjects, options);

        public static T ObjectField<T>(string label, T obj, bool allowSceneObjects, params GUILayoutOption[] options)
            where T : Object => (T) EditorGUILayout.ObjectField(label, obj, typeof(T), allowSceneObjects, options);
        ...
        public static void
            ObjectField(SerializedProperty property, GUIContent label, params GUILayoutOption[] options) =>
        ...
        public static void ObjectField(SerializedProperty property, Type objType, GUIContent label,
            params GUILayoutOption[] options) => EditorGUILayout.ObjectField(property, objType, label, options);
        ...
        public static void ObjectField<T>(SerializedProperty property, GUIContent label,
            params GUILayoutOption[] options) => EditorGUILayout.ObjectField(property, typeof(T), label, options);
        ...
        public static int MaskField(GUIContent label, int mask, string[] displayedOptions,
            params GUILayoutOption[] options) => EditorGUILayout.MaskField(label, mask, displayedOptions, options);
        ...
        public static int
            MaskField(string label, int mask, string[] displayedOptions, params GUILayoutOption[] options) =>
        ...
        public static int MaskField(int mask, string[] displayedOptions, GUIStyle style,
            params GUILayoutOption[] options) => EditorGUILayout.MaskField(mask, displayedOptions, style, options);
        ...
        public static int Popup(int selectedIndex, string[] displayedOptions, GUIStyle style,
            params GUILayoutOption[] options) => EditorGUILayout.Popup(selectedIndex, displayedOptions, style, options);
        ...
        public static int Popup(string label, int selectedIndex, string[] displayedOptions,
            params GUILayoutOption[] options) => EditorGUILayout.Popup(label, selectedIndex, displayedOptions, options);
        ...
        public static void LabelField(GUIContent label, GUIContent label2, GUIStyle style,
            params GUILayoutOption[] options) => EditorGUILayout.LabelField(label, label2, style, options);
        ...
        public static bool FoldoutHeader(bool foldout, string content, bool toggleOnLabelClick) =>
            EditorGUILayout.Foldout(foldout, content, toggleOnLabelClick, EditorStyles.foldoutHeader);
        ...
        public static bool RepeatButton(string content, GUIStyle style, Action action,
            params GUILayoutOption[] options) {
        ...
        public static bool RepeatButton(Texture image, GUIStyle style, Action action,
            params GUILayoutOption[] options) {
        ...
        public static bool SectionFoldout(bool foldout, string label, Color backgroundColor, Color lineColor,
            ...
            Rect position = EditorGUILayout.GetControlRect(false, EditorGUIUtility.singleLineHeight + 5f, options);
            bool value = LucidEditorGUI.SectionFoldout(position, foldout, label, backgroundColor, lineColor,
                toggleOnLabelClick);
            Space(3);
            return value;
        }
        ...
        public static int BeginTabGroup(int selected, GUIStyle style, string[] items,
            params GUILayoutOption[] options) {
            EditorGUILayout.BeginVertical(style);
            Rect position = EditorGUILayout.GetControlRect(false, EditorGUIUtility.singleLineHeight + 2f,
        ...
        public static bool BeginToggleGroup(string label, bool toggle, GUIStyle style,
            params GUILayoutOption[] options) {
