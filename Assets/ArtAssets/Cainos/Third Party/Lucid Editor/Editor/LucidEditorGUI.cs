...
namespace Cainos.LucidEditor {
    public static class LucidEditorGUI {
        ...
        public static T Field<T>(Rect position, GUIContent label, T value) {
            switch (value) {
                ...
                case AnimationCurve animationCurveValue:
                    return GenericTypeConverter<T>.Convert<AnimationCurve>(CurveField(position, label,
                        animationCurveValue));
                case Object objectValue:
                    return GenericTypeConverter<T>.Convert<Object>(ObjectField(position, label, objectValue,
        ...
        public static bool PropertyField(Rect position, SerializedProperty property, GUIContent label,
            bool includeChildren) => EditorGUI.PropertyField(position, property, label, includeChildren);

        public static void MultiPropertyField(Rect position, GUIContent[] subLabels, SerializedProperty valuesIterator,
            GUIContent label) => EditorGUI.MultiPropertyField(position, subLabels, valuesIterator, label);

        public static void
            MultiPropertyField(Rect position, GUIContent[] subLabels, SerializedProperty valuesIterator) =>
        ...
        public static int IntPopup(Rect position, int selectedValue, string[] displayedOptions, int[] optionValues,
            GUIStyle style) => EditorGUI.IntPopup(position, selectedValue, displayedOptions, optionValues, style);

        public static int
            IntPopup(Rect position, int selectedValue, GUIContent[] displayedOptions, int[] optionValues) =>
            EditorGUI.IntPopup(position, selectedValue, displayedOptions, optionValues);
        ...
        public static int IntPopup(Rect position, string label, int selectedValue, string[] displayedOptions,
            int[] optionValues) => EditorGUI.IntPopup(position, label, selectedValue, displayedOptions, optionValues);

        public static int IntPopup(Rect position, string label, int selectedValue, string[] displayedOptions,
            int[] optionValues, GUIStyle style) =>
            EditorGUI.IntPopup(position, label, selectedValue, displayedOptions, optionValues, style);
        ...
        public static void IntPopup(Rect position, SerializedProperty property, GUIContent[] displayedOptions,
            int[] optionValues) => EditorGUI.IntPopup(position, property, displayedOptions, optionValues);
        ...
        public static void IntSlider(Rect position, SerializedProperty property, int leftValue, int rightValue,
            string label) => EditorGUI.IntSlider(position, property, leftValue, rightValue, label);

        public static void IntSlider(Rect position, SerializedProperty property, int leftValue, int rightValue,
            GUIContent label) => EditorGUI.IntSlider(position, property, leftValue, rightValue, label);
        ...
        public static float
            FloatSlider(Rect position, GUIContent label, float value, float leftValue, float rightValue) =>
            EditorGUI.Slider(position, label, value, leftValue, rightValue);
        ...
        public static void FloatSlider(Rect position, SerializedProperty property, float leftValue, float rightValue,
            string label) => EditorGUI.Slider(position, property, leftValue, rightValue, label);

        public static void FloatSlider(Rect position, SerializedProperty property, float leftValue, float rightValue,
            GUIContent label) => EditorGUI.Slider(position, property, leftValue, rightValue, label);
        ...
        public static Color ColorField(Rect position, GUIContent label, Color value, bool showEyedropper,
            bool showAlpha, bool hdr) => EditorGUI.ColorField(position, label, value, showEyedropper, showAlpha, hdr);
        ...
        public static AnimationCurve CurveField(Rect position, string label, AnimationCurve value, Color color,
            Rect ranges) => EditorGUI.CurveField(position, label, value, color, ranges);
        ...
        public static void CurveField(Rect position, SerializedProperty property, Color color, Rect ranges,
            GUIContent label) => EditorGUI.CurveField(position, property, color, ranges, label);
        ...
        public static Enum EnumPopup(Rect position, GUIContent label, Enum selected, Func<Enum, bool> checkEnabled,
            bool includeObsolete) => EditorGUI.EnumPopup(position, label, selected, checkEnabled, includeObsolete);
        ...
        public static TEnum EnumPopup<TEnum>(Rect position, GUIContent label, TEnum selected,
            ...
            (TEnum) EditorGUI.EnumPopup(position, label, selected, checkEnabled, includeObsolete, style);
        ...
        public static Object
            ObjectField(Rect position, string label, Object obj, Type objType, bool allowSceneObjects) =>
        ...
        public static Object ObjectField(Rect position, GUIContent label, Object obj, Type objType,
            bool allowSceneObjects) => EditorGUI.ObjectField(position, label, obj, objType, allowSceneObjects);
        ...
        public static T ObjectField<T>(Rect position, GUIContent label, T obj, bool allowSceneObjects)
            where T : Object => (T) EditorGUI.ObjectField(position, label, obj, typeof(T), allowSceneObjects);
        ...
        public static int MaskField(Rect position, GUIContent label, int mask, string[] displayedOptions,
            GUIStyle style) => EditorGUI.MaskField(position, label, mask, displayedOptions, style);
        ...
        public static int Popup(Rect position, string label, int selectedIndex, string[] displayedOptions,
            GUIStyle style) => EditorGUI.Popup(position, label, selectedIndex, displayedOptions, style);
        ...
        public static void HandlePrefixLabel(Rect totalPosition, Rect labelPosition, GUIContent label, int id,
            GUIStyle style) => EditorGUI.HandlePrefixLabel(totalPosition, labelPosition, label, id, style);
        ...
        public static void MinMaxSlider(Rect position, ref float minValue, ref float maxValue, float minLimit,
            float maxLimit) => EditorGUI.MinMaxSlider(position, ref minValue, ref maxValue, minLimit, maxLimit);
        ...
        public static bool
            Foldout(Rect position, bool foldout, string content, bool toggleOnLabelClick, GUIStyle style) =>
        ...
        public static bool Foldout(Rect position, bool foldout, GUIContent content, bool toggleOnLabelClick,
            GUIStyle style) => EditorGUI.Foldout(position, foldout, content, toggleOnLabelClick, style);
        ...
        public static bool FoldoutHeader(Rect position, bool foldout, string content, bool toggleOnLabelClick) =>
            EditorGUI.Foldout(position, foldout, content, toggleOnLabelClick, EditorStyles.foldoutHeader);
