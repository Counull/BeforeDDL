    ...
    public sealed class Cookie : IComparable<Cookie>, IEquatable<Cookie> {
        ...
        public static Cookie Parse(string header, Uri defaultDomain, LoggingContext context) {
            ...
            try {
                ...
                HTTPManager.Logger.Warning("Cookie",
                    "Parse - Couldn't parse header: " + header + " exception: " + ex.ToString() + " " + ex.StackTrace,
                    context);
            }
        ...
        public bool Equals(Cookie cookie) {
            ...
            return this.Name.Equals(cookie.Name, StringComparison.Ordinal) &&
                   ((this.Domain == null && cookie.Domain == null) ||
                    this.Domain.Equals(cookie.Domain, StringComparison.Ordinal)) &&
                   ((this.Path == null && cookie.Path == null) ||
                    this.Path.Equals(cookie.Path, StringComparison.Ordinal));
        }
