        ...
        public static List<Cookie> Get(Uri uri) {
            ...
            try {
                ...
                for (int i = 0; i < Cookies.Count; ++i) {
                    ...
                    bool domainMatch = uri.Host.IndexOf(cookie.Domain) != -1 ||
                                       string.Format("{0}:{1}", uri.Host, uri.Port).IndexOf(cookie.Domain) != -1;
                    ...
                    if (willExpireInTheFuture && domainMatch) {
                        ...
                        bool prefixMatch = cookie.Path[cookie.Path.Length - 1] == '/' &&
