...
namespace Best.HTTP.Hosts.Settings {
    ...
    public delegate Best.HTTP.Shared.TLS.AbstractTls13Client TlsClientFactoryDelegate(Uri uri,
        List<SecureProtocol.Org.BouncyCastle.Tls.ProtocolName> protocols, LoggingContext context);
#endif
    ...
    public delegate X509Certificate ClientCertificateSelector(string targetHost,
    ...
    public class BouncyCastleSettings {
        ...
        /// <param name="context">The logging context for the operation.</param>
        /// <returns>A TLS 1.3 client instance.</returns>
        public static Best.HTTP.Shared.TLS.AbstractTls13Client DefaultTlsClientFactory(Uri uri,
            List<Best.HTTP.SecureProtocol.Org.BouncyCastle.Tls.ProtocolName> protocols, LoggingContext context) {
            ...
            if (!uri.IsHostIsAnIPAddress()) {
                ...
                hostNames.Add(
                    new Best.HTTP.SecureProtocol.Org.BouncyCastle.Tls.ServerName(0,
                        System.Text.Encoding.UTF8.GetBytes(uri.Host)));
            }
    ...
    public class FrameworkTLSSettings {
        ...
        /// </summary>
        public System.Security.Authentication.SslProtocols TlsVersions =
        ...
        /// </summary>
        public static Func<string, X509Certificate, X509Chain, SslPolicyErrors, bool> DefaultCertificationValidator =
            (host, certificate, chain, sslPolicyErrors) => true;

        public Func<string, X509Certificate, X509Chain, SslPolicyErrors, bool> CertificationValidator =
    ...
    public class HostSettings {
        ...
        /// </summary>
        public Best.HTTP.Hosts.Connections.HTTP2.HTTP2ConnectionSettings HTTP2ConnectionSettings =
            new Connections.HTTP2.HTTP2ConnectionSettings();
#endif
