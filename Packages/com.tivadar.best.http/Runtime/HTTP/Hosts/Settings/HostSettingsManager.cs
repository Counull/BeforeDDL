...
namespace Best.HTTP.Hosts.Settings {
    ...
    public sealed class HostSettingsManager {
        ...
        public HostSettings Get(HostVariant variant, bool fallbackToWildcard = true) =>
            Get(variant.Host, fallbackToWildcard);
        ...
        public HostSettings Get(HostKey hostKey, bool fallbackToWildcard = true) =>
            Get(hostKey.Host, fallbackToWildcard);
