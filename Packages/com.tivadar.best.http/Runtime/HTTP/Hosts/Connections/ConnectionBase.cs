...
namespace Best.HTTP.Hosts.Connections {
    ...
    public abstract class ConnectionBase : IDisposable {
        ...
        /// </summary>
        public virtual int AssignedRequests {
            get {
                return this.State != HTTPConnectionStates.Initial && this.State != HTTPConnectionStates.Free ? 1 : 0;
            }
        }
        ...
        public ConnectionBase(HostKey hostKey, bool threaded) {
            ...
            this.KeepAliveTime = HTTPManager.PerHostSettings.Get(this.HostKey.Host).HTTP1ConnectionSettings
