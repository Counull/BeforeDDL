...
namespace Best.HTTP.Hosts.Connections.HTTP2 {
    ...
    public struct HTTP2FrameHeaderAndPayload {
        ...
        public override string ToString() {
            return
                $"[HTTP2FrameHeaderAndPayload Type: {Type}, Flags: {Flags.ToBinaryStr()}, StreamId: {StreamId}, DontUseMemPool: {DontUseMemPool}, Payload: {Payload}]";
        }
    ...
    public struct HTTP2SettingsFrame {
        ...
        public override string ToString() {
            ...
            return string.Format("[HTTP2SettingsFrame Header: {0}, Flags: {1}, Settings: {2}]", this.Header.ToString(),
    ...
    public struct HTTP2RSTStreamFrame {
        ...
        public override string ToString() {
            return string.Format("[HTTP2RST_StreamFrame Header: {0}, Error: {1}({2})]", this.Header.ToString(),
    ...
    public struct HTTP2GoAwayFrame {
        ...
        public override string ToString() {
            return string.Format(
                "[HTTP2GoAwayFrame Header: {0}, ReservedBit: {1}, LastStreamId: {2}, Error: {3}({4}), AdditionalDebugData: {5}]",
                this.Header.ToString(),
                this.ReservedBit,
                this.LastStreamId,
                this.Error,
