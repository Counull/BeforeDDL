...
namespace Best.HTTP.Hosts.Connections.WebGL
{
    ...
    internal sealed class WebGLXHRConnection : ConnectionBase
    {
        ...
        protected override void ThreadFunc()
        {
            ...
            {
                var internalBuffer =
 BufferPool.Get(upStream.Length > 0 ? upStream.Length : CurrentRequest.UploadSettings.UploadChunkSize, true);
 ...
 new BufferPoolMemoryStream(internalBuffer, 0, internalBuffer.Length, true, true, false, true))
            ...
            if (this._response == null)
                this.CurrentRequest.Response = this._response =
 new PeekableHTTP1Response(this.CurrentRequest, false, null);
        ...
        void FinishedProcessing(Exception ex)
        {
            ...
            else
            {
                ...
                error =
 ConnectionHelper.HandleResponse(req, out resendRequest, out connectionState, ref keepAlive, this.Context);
