...
{
    delegate void OnWebGLXHRRequestHandlerDelegate(int nativeId, [MarshalAs(UnmanagedType.LPArray, ArraySubType =
 UnmanagedType.U1, SizeParamIndex = 2)] byte[] pBuffer, int length);
    delegate void OnWebGLXHRBufferDelegate(int nativeId, [MarshalAs(UnmanagedType.LPArray, ArraySubType =
 UnmanagedType.U1, SizeParamIndex = 2)] byte[] pBuffer, int length);
    ...
    internal static class WebGLXHRNativeInterface
    {
        ...
        [DllImport("__Internal")]
        public static extern void XHR_Send(int nativeId, [MarshalAs(UnmanagedType.LPArray, ArraySubType =
