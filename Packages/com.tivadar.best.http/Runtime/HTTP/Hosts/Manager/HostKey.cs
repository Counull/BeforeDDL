...
namespace Best.HTTP.HostSetting {
    ...
    public readonly struct HostKey {
        ...
        /// </summary>
        public string Host {
            get => !this.Uri.IsFile ? this.Uri.Host : "file";
        }
        ...
        public override string ToString() =>
            $"{{\"Uri\":\"{this.Uri.GetComponents(UriComponents.SchemeAndServer, UriFormat.Unescaped)}\", \"Proxy\": {this.Proxy.ToString()}, \"Key\": {this.Key.ToString()}}}";
