...
namespace Best.HTTP.Request.Settings {
    ...
    public delegate void OnHeadersReceivedDelegate(HTTPRequest req, HTTPResponse resp,
    ...
    public delegate DownloadContentStream OnCreateDownloadStreamDelegate(HTTPRequest req, HTTPResponse resp,
    ...
    public delegate bool OnUpgradedDelegate(HTTPRequest req, HTTPResponse resp,
