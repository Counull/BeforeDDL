...
namespace Best.HTTP.Request.Settings {
    ...
    public class TimeoutSettings {
        ...
        public TimeSpan ConnectTimeout {
            get => this._connectTimeout ?? HTTPManager.PerHostSettings.Get(this._request.CurrentHostKey.Host)
        ...
        public TimeSpan Timeout {
            get => this._timeout ?? HTTPManager.PerHostSettings.Get(this._request.CurrentHostKey.Host).RequestSettings
                .RequestTimeout;
        ...
        public bool IsConnectTimedOut(DateTime now) =>
            this.QueuedAt != DateTime.MinValue && now - this.QueuedAt > this.ConnectTimeout;
