        ...
        public static SubjectPublicKeyInfo CreateSubjectPublicKeyInfo(
            ...
            if (publicKey is ECPublicKeyParameters) {
                ...
                if (_key.Parameters is ECGost3410Parameters) {
                    ...
                    return new SubjectPublicKeyInfo(new AlgorithmIdentifier(algIdentifier, parameters),
            ...
            throw new ArgumentException("Class provided no convertible: " +
                                        Org.BouncyCastle.Utilities.Platform.GetTypeName(publicKey));
        }
