    ...
    internal class SecT163R1Curve
        ...
        public SecT163R1Curve()
            ...
            this.m_a = FromBigInteger(new BigInteger(1,
                Hex.DecodeStrict("07B6882CAAEFA84F9554FF8428BD88E246D2782AE2")));
            this.m_b = FromBigInteger(new BigInteger(1,
                Hex.DecodeStrict("0713612DCDDCB40AAB946BDA29CA91F73AF958AFD9")));
        ...
        private class SecT163R1LookupTable
            ...
            private ECPoint CreatePoint(ulong[] x, ulong[] y) {
                return m_outer.CreateRawPoint(new SecT163FieldElement(x), new SecT163FieldElement(y),
                    SECT163R1_AFFINE_ZS);
            }
        }
    }
