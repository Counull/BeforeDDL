    ...
    public static class CipherUtilities {
        ...
        public static IBufferedCipher GetCipher(string algorithm) {
            ...
            if (Org.BouncyCastle.Utilities.Platform.StartsWith(algorithm, "PBE")) {
                ...
                else if (Org.BouncyCastle.Utilities.Platform.EndsWith(algorithm, "-BC") ||
                         Org.BouncyCastle.Utilities.Platform.EndsWith(algorithm, "-OPENSSL")) {
        ...
        private static IBlockCipher CreateBlockCipher(CipherAlgorithm cipherAlgorithm) {
            switch (cipherAlgorithm) {
                ...
                default:
                    throw new SecurityUtilityException("Cipher " + cipherAlgorithm +
                                                       " not recognised or not a block cipher");
            }
        }
    }
}
