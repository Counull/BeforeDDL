    ...
    public class TimeStampTokenGenerator {
        ...
        public TimeStampTokenGenerator(
            ...
            try {
                ...
                if (((AlgorithmIdentifier) digestCalculator.AlgorithmDetails).Algorithm.Equals(OiwObjectIdentifiers
                        .IdSha1)) {
        ...
        internal static SignerInfoGenerator makeInfoGenerator(
            ...
            string signatureName = digestName + "with" +
                                   CmsSignedHelper.Instance.GetEncryptionAlgName(
                                       CmsSignedHelper.Instance.GetEncOid(key, digestOID));
