        ...
        */
                ...
                try {
                    ...
                    if (paramsPKIX.IsUseDeltasEnabled) {
                        ...
                        ISet<X509Crl> deltaCRLs =
                            PkixCertPathValidatorUtilities.GetDeltaCrls(currentDate, paramsPKIX, crl);
        ...
        internal static void CheckCrls(
            ...
            try {
                crldp = CrlDistPoint.GetInstance(
                    PkixCertPathValidatorUtilities.GetExtensionValue(cert, X509Extensions.CrlDistributionPoints));
            }
            catch (Exception e) {
        ...
        internal static void ProcessCertA(
            ...
            if (paramsPKIX.IsRevocationEnabled) {
                try {
                    CheckCrls(paramsPKIX, cert, PkixCertPathValidatorUtilities.GetValidCertDateFromValidityModel(
                        paramsPKIX,
            ...
            if (!issuer.Equivalent(workingIssuerName, true)) {
                throw new PkixCertPathValidatorException("IssuerName(" + issuer
                                                                       ...
                                                                       workingIssuerName + ") of signing certificate.",
                    null, index);
            }
        }
        ...
        internal static void PrepareNextCertO(PkixCertPath certPath, int index, ISet<string> criticalExtensions,
            ...
            if (criticalExtensions.Count > 0) {
                throw new PkixCertPathValidatorException("Certificate has unsupported critical extension.", null,
                    index);
            }
        }
        ...
        internal static void ProcessCrlC(
            ...
            try {
                completeidp = IssuingDistributionPoint.GetInstance(
                    PkixCertPathValidatorUtilities.GetExtensionValue(completeCRL,
            ...
            if (pkixParams.IsUseDeltasEnabled) {
                ...
                try {
                    deltaidp = IssuingDistributionPoint.GetInstance(
                        PkixCertPathValidatorUtilities.GetExtensionValue(deltaCRL,
                            X509Extensions.IssuingDistributionPoint));
                }
                catch (Exception e) {
                    throw new Exception(
