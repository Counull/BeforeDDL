...
namespace Best.HTTP.SecureProtocol.Org.BouncyCastle.Pkix {
    public class PkixNameConstraintValidator {
        ...
        private static bool WithinDNSubtree(
            ...
            for (int j = 0; j < subtree.Count; ++j) {
                ...
                if (subtreeRdn.Count == 1 && dnsRdn.Count == 1
                    ...
                    if (!Org.BouncyCastle.Utilities.Platform.StartsWith(dnsRdn.GetFirst().Value.ToString(),
        ...
        private bool IsDnsConstrained(string constraint, string dns) {
            return WithinDomain(dns, constraint) ||
                   Org.BouncyCastle.Utilities.Platform.EqualsIgnoreCase(dns, constraint);
        }
        ...
        private bool WithinDomain(string testDomain, string domain) {
            ...
            for (int i = -1; i < domainParts.Length; i++) {
                ...
                else if (!Org.BouncyCastle.Utilities.Platform.EqualsIgnoreCase(testDomainParts[i + d],
                             domainParts[i])) {
                    return false;
                }
            }
            ...
            // email1 specifies a domain
                ...
                // email2 specifies a domain
                    ...
                    if (WithinDomain(email1, email2) ||
                        Org.BouncyCastle.Utilities.Platform.EqualsIgnoreCase(email1, email2)) {
                        union.Add(email2);
                    }
