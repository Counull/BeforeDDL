        ...
        public static PrivateKeyInfo CreatePrivateKeyInfo(AsymmetricKeyParameter privateKey, Asn1Set attributes) {
            ...
            if (privateKey is ElGamalPrivateKeyParameters) {
                ...
                return new PrivateKeyInfo(
                    new AlgorithmIdentifier(OiwObjectIdentifiers.ElGamalAlgorithm,
                        new ElGamalParameter(egp.P, egp.G).ToAsn1Object()),
            ...
            if (privateKey is DsaPrivateKeyParameters) {
                ...
                return new PrivateKeyInfo(
                    new AlgorithmIdentifier(X9ObjectIdentifiers.IdDsa,
                        new DsaParameter(dp.P, dp.Q, dp.G).ToAsn1Object()),
                    new DerInteger(_key.X),
                    attributes);
            }
            ...
            if (privateKey is ECPrivateKeyParameters) {
                ...
                DerBitString publicKey =
                    new DerBitString(ECKeyPairGenerator.GetCorrespondingPublicKey(priv).Q.GetEncoded(false));
            ...
            throw new ArgumentException("Class provided is not convertible: " +
                                        Org.BouncyCastle.Utilities.Platform.GetTypeName(privateKey));
        }
