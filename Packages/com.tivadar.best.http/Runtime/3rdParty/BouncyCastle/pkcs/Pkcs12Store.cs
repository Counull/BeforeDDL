...
namespace Best.HTTP.SecureProtocol.Org.BouncyCastle.Pkcs {
    public class Pkcs12Store {
        public const string IgnoreUselessPasswordProperty =
            "Best.HTTP.SecureProtocol.Org.BouncyCastle.Pkcs12.IgnoreUselessPassword";
        ...
        public void Load(Stream input, char[] password) {
            ...
            if (bag.MacData != null) // check the mac code
            {
                ...
                string ignoreProperty =
                    Org.BouncyCastle.Utilities.Platform.GetEnvironmentVariable(IgnoreUselessPasswordProperty);
                bool ignore = ignoreProperty != null &&
                              Org.BouncyCastle.Utilities.Platform.EqualsIgnoreCase("true", ignoreProperty);
