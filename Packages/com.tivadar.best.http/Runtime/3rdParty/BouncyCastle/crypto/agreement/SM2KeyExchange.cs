...
namespace Best.HTTP.SecureProtocol.Org.BouncyCastle.Crypto.Agreement {
    ...
    public class SM2KeyExchange {
        ...
        public virtual byte[][] CalculateKeyWithConfirmation(int kLen, byte[] confirmationTag,
            ...
            if (mInitiator) {
                ...
                byte[] inner =
                    CalculateInnerHash(mDigest, U, za, zb, mEphemeralPubPoint, otherPub.EphemeralPublicKey.Q);
                ...
                byte[] inner =
                    CalculateInnerHash(mDigest, U, zb, za, otherPub.EphemeralPublicKey.Q, mEphemeralPubPoint);
