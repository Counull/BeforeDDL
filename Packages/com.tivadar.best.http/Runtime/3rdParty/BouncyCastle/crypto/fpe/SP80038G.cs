...
namespace Best.HTTP.SecureProtocol.Org.BouncyCastle.Crypto.Fpe {
    ...
    internal class SP80038G {
        ...
        public static ushort[] DecryptFF1w(IBlockCipher cipher, int radix, byte[] tweak, ushort[] buf, int off,
            int len) {
            checkArgs(cipher, true, radix, buf, off, len);
        ...
        private static ushort[] decFF1(IBlockCipher cipher, int radix, byte[] T, int n, int u, int v, ushort[] A,
            ushort[] B) {
            int t = T.Length;
        ...
        public static byte[] DecryptFF3_1(IBlockCipher cipher, int radix, byte[] tweak56, byte[] buf, int off,
            int len) {
            checkArgs(cipher, false, radix, buf, off, len);
        ...
        public static ushort[] DecryptFF3_1w(IBlockCipher cipher, int radix, byte[] tweak56, ushort[] buf, int off,
            int len) {
            checkArgs(cipher, false, radix, buf, off, len);
        ...
        public static ushort[] EncryptFF1w(IBlockCipher cipher, int radix, byte[] tweak, ushort[] buf, int off,
            int len) {
            checkArgs(cipher, true, radix, buf, off, len);
        ...
        private static ushort[] encFF1(IBlockCipher cipher, int radix, byte[] T, int n, int u, int v, ushort[] A,
            ushort[] B) {
            int t = T.Length;
        ...
        public static ushort[] EncryptFF3w(IBlockCipher cipher, int radix, byte[] tweak64, ushort[] buf, int off,
            int len) {
            checkArgs(cipher, false, radix, buf, off, len);
        ...
        public static ushort[] EncryptFF3_1w(IBlockCipher cipher, int radix, byte[] tweak56, ushort[] buf, int off,
            int len) {
            checkArgs(cipher, false, radix, buf, off, len);
        ...
        public static byte[] EncryptFF3_1(IBlockCipher cipher, int radix, byte[] tweak56, byte[] buf, int off,
            int len) {
            checkArgs(cipher, false, radix, buf, off, len);
        ...
        protected static BigInteger calculateY_FF1(IBlockCipher cipher, BigInteger bigRadix, byte[] T, int b, int d,
        ...
        protected static byte[] implDecryptFF3(IBlockCipher cipher, int radix, byte[] tweak64, byte[] buf, int off,
            int len) {
            // Algorithm 10
            byte[] T = tweak64;
            int n = len;
        ...
        protected static ushort[] implDecryptFF3w(IBlockCipher cipher, int radix, byte[] tweak64, ushort[] buf, int off,
            int len) {
            // Algorithm 10
            byte[] T = tweak64;
            int n = len;
        ...
        private static ushort[] decFF3_1(IBlockCipher cipher, int radix, byte[] T, int n, int v, int u, ushort[] A,
            ushort[] B) {
            BigInteger bigRadix = BigInteger.ValueOf(radix);
        ...
        protected static byte[] implEncryptFF3(IBlockCipher cipher, int radix, byte[] tweak64, byte[] buf, int off,
            int len) {
            // Algorithm 9
            byte[] T = tweak64;
            int n = len;
        ...
        protected static ushort[] implEncryptFF3w(IBlockCipher cipher, int radix, byte[] tweak64, ushort[] buf, int off,
            int len) {
            // Algorithm 9
            byte[] T = tweak64;
            int n = len;
        ...
        private static ushort[] encFF3_1(IBlockCipher cipher, int radix, byte[] t, int n, int v, int u, ushort[] a,
            ushort[] b) {
            BigInteger bigRadix = BigInteger.ValueOf(radix);
            BigInteger[] modVU = calculateModUV(bigRadix, v, u);
