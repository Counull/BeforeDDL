...
namespace Best.HTTP.SecureProtocol.Org.BouncyCastle.Crypto.Fpe {
    public class FpeFf3_1Engine
        ...
        public override void Init(bool forEncryption, ICipherParameters parameters) {
            ...
            baseCipher.Init(!fpeParameters.UseInverseFunction,
                new KeyParameter(Arrays.Reverse(fpeParameters.Key.GetKey())));
        ...
        protected override int EncryptBlock(byte[] inBuf, int inOff, int length, byte[] outBuf, int outOff) {
            ...
            if (fpeParameters.Radix > 256) {
                ...
                enc = SP80038G.EncryptFF3_1(baseCipher, fpeParameters.Radix, fpeParameters.GetTweak(), inBuf, inOff,
                    length);
            }
        ...
        protected override int DecryptBlock(byte[] inBuf, int inOff, int length, byte[] outBuf, int outOff) {
            ...
            if (fpeParameters.Radix > 256) {
                ...
                dec = SP80038G.DecryptFF3_1(baseCipher, fpeParameters.Radix, fpeParameters.GetTweak(), inBuf, inOff,
                    length);
            }
