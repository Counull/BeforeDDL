...
namespace Best.HTTP.SecureProtocol.Org.BouncyCastle.Crypto.Prng {
    ...
    public class SP800SecureRandomBuilder {
         ...
         */
        public SP800SecureRandom BuildCtr(IBlockCipher cipher, int keySizeInBits, byte[] nonce,
            bool predictionResistant) {
            return new SP800SecureRandom(mRandom, mEntropySourceProvider.Get(mEntropyBitsRequired),
                new CtrDrbgProvider(cipher, keySizeInBits, nonce, mPersonalizationString, mSecurityStrength),
                predictionResistant);
        }
        ...
        private class CtrDrbgProvider
            ...
            public CtrDrbgProvider(IBlockCipher blockCipher, int keySizeInBits, byte[] nonce,
            ...
            public ISP80090Drbg Get(IEntropySource entropySource) {
                return new CtrSP800Drbg(mBlockCipher, mKeySizeInBits, mSecurityStrength, entropySource,
                    mPersonalizationString, mNonce);
            }
        }
    }
}
