...
namespace Best.HTTP.SecureProtocol.Org.BouncyCastle.Cms {
    ...
    public class SignerInfoGenerator {
        ...
        internal SignerInfoGenerator(SignerIdentifier sigId, ISignatureFactory signerFactory) : this(sigId,
            signerFactory, false) { }
    ...
    public class SignerInfoGeneratorBuilder {
        ...
        public SignerInfoGenerator Build(ISignatureFactory contentSigner, X509Certificate certificate) {
            SignerIdentifier sigId =
                new SignerIdentifier(new IssuerAndSerialNumber(certificate.IssuerDN,
