    ...
    public abstract class TlsCryptoUtilities {
        ...
        public static int GetHash(short hashAlgorithm) {
            switch (hashAlgorithm) {
                ...
                default:
                    throw new ArgumentException("specified HashAlgorithm invalid: " +
                                                HashAlgorithm.GetText(hashAlgorithm));
            }
        }
        ...
        public static int GetHashForHmac(int macAlgorithm) {
            switch (macAlgorithm) {
                ...
                case MacAlgorithm.hmac_sha512:
                    return CryptoHashAlgorithm.sha512;
                default:
                    throw new ArgumentException("specified MacAlgorithm not an HMAC: " +
                                                MacAlgorithm.GetText(macAlgorithm));
            }
        }
