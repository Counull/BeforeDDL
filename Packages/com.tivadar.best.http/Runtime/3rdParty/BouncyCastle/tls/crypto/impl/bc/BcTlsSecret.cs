...
namespace Best.HTTP.SecureProtocol.Org.BouncyCastle.Tls.Crypto.Impl.BC {
    ...
    public class BcTlsSecret
        ...
        public static BcTlsSecret Convert(BcTlsCrypto crypto, TlsSecret secret) {
            ...
            throw new ArgumentException("unrecognized TlsSecret - cannot copy data: " +
                                        Org.BouncyCastle.Utilities.Platform.GetTypeName(secret));
        }
            ...
            lock (this) {
                ...
                switch (prfAlgorithm) {
                    case PrfAlgorithm.tls13_hkdf_sha256:
                        return TlsCryptoUtilities.HkdfExpandLabel(this, CryptoHashAlgorithm.sha256, label, seed,
                            length);
                    case PrfAlgorithm.tls13_hkdf_sha384:
                        return TlsCryptoUtilities.HkdfExpandLabel(this, CryptoHashAlgorithm.sha384, label, seed,
                            length);
