...
namespace Best.HTTP.SecureProtocol.Org.BouncyCastle.Asn1.Cmp {
    ...
    public class PkiFailureInfo
        ...
        public const int
            WrongAuthority =
                (1 << 1); // the authority indicated in the request is different from the one creating the response token
        ...
        public const int
            AddInfoNotAvailable =
                (1 << 22); //the additional information requested could not be understood or is not available
