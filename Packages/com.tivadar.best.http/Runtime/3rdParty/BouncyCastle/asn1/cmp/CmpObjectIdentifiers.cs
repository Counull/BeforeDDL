...
namespace Best.HTTP.SecureProtocol.Org.BouncyCastle.Asn1.Cmp {
    public static class CmpObjectIdentifiers {
        ...
        public static readonly DerObjectIdentifier
            id_it_rootCaKeyUpdate = new DerObjectIdentifier("1.3.6.1.5.5.7.4.18");
         ...
         */
        public static readonly DerObjectIdentifier
            id_it_certReqTemplate = new DerObjectIdentifier("1.3.6.1.5.5.7.4.19");
        ...
        public static readonly DerObjectIdentifier regCtrl_protocolEncrKey =
            new DerObjectIdentifier("1.3.6.1.5.5.7.5.1.6");
        ...
        public static readonly DerObjectIdentifier regCtrl_altCertTemplate =
            new DerObjectIdentifier("1.3.6.1.5.5.7.5.1.7");
        ...
        public static readonly DerObjectIdentifier ct_encKeyWithID =
            new DerObjectIdentifier("1.2.840.113549.1.9.16.1.21");
