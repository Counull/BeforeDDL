    ...
    public class DerExternal
        ...
        public static DerExternal GetInstance(object obj) {
            ...
            throw new ArgumentException(
                "illegal object in GetInstance: " + Org.BouncyCastle.Utilities.Platform.GetTypeName(obj), "obj");
        }
        ...
        */
        ...
        private static Asn1Object GetExternalContent(Asn1TaggedObject encoding) {
            ...
            switch (tagNo) {
                ...
                default:
                    throw new ArgumentException("invalid tag: " + Asn1Utilities.GetTagText(tagClass, tagNo),
                        "encoding");
            }
        }
