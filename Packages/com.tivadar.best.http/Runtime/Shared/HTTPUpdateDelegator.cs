    ...
    public sealed class HTTPUpdateDelegator : MonoBehaviour {
        ...
        public static HTTPUpdateDelegator CheckInstance() {
            try {
                ...
                HTTPManager.Logger.Error(nameof(HTTPUpdateDelegator),
                    "Please call the Best.HTTPManager.Setup() from one of Unity's event(eg. awake, start) before you send any request!");
            }
        ...
        private void Setup() {
            ...
            HTTPManager.Logger.Information(nameof(HTTPUpdateDelegator),
                $"Setup called Threading Mode: {this._currentThreadingMode}, MainThreadId: {this.mainThreadId}");
        ...
        /// </summary>
        public void SwapThreadingMode() => SetThreadingMode(_currentThreadingMode == ThreadingMode.Threaded
