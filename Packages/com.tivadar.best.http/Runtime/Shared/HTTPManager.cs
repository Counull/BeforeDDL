...
namespace Best.HTTP.Shared {
    ...
    public static partial class HTTPManager {
        ...
        static HTTPManager() {
            ...
            UserAgent =
                $"com.Tivadar.Best.HTTP v{typeof(HTTPManager)?.Assembly?.GetName()?.Version}/Unity {UnityEngine.Application.unityVersion}";
        }
            ...
            try {
                ...
                using (new Unity.Profiling.ProfilerMarker("Profile").Auto()) {
                    // Sent
                    {
                        ...
                        Profiler.Network.NetworkStats.BufferedToSend.Value =
                            Profiler.Network.NetworkStatsCollector.BufferedToSend;
                    }
                    ...
                    // Received
                    {
                        ...
                        Profiler.Network.NetworkStats.ReceivedAndUnprocessed.Value =
                            Profiler.Network.NetworkStatsCollector.ReceivedAndUnprocessed;
                    }

                    // Open/Total connections
                    Profiler.Network.NetworkStats.OpenConnectionsCounter.Value =
                        Profiler.Network.NetworkStatsCollector.OpenConnections;
                    Profiler.Network.NetworkStats.TotalConnectionsCounter.Value =
                        Profiler.Network.NetworkStatsCollector.TotalConnections;
