...
namespace Best.HTTP.Shared.TLS.Crypto.Impl {
        ...
        */
        public void Init(bool forEncryption, ICipherParameters parameters) {
            if (!(parameters is KeyParameter keyParameter))
                throw new ArgumentException("invalid parameter passed to AES init - "
                                            + Best.HTTP.SecureProtocol.Org.BouncyCastle.Utilities.Platform.GetTypeName(
                                                parameters));
        ...
        public unsafe int ProcessBlock(ReadOnlySpan<byte> input, Span<byte> output) {
            ...
            if (forEncryption) {
                ...
                fixed (uint* pT0 = T0) {
                    while (r < ROUNDS - 1) {
                        ...
                        fixed (uint* pkw = kw) {
                            ...
                            tmp2 = pT0[(t2 >> 16) & 255];
                            tmp3 = pT0[(r3 >> 24) & 255];
                            shift1 = (tmp1 >> 24) | (tmp1 << 8);
                            shift2 = (tmp2 >> 16) | (tmp2 << 16);
                            shift3 = (tmp3 >> 8) | (tmp3 << 24);
                ...
                fixed (byte* pS = S)
                fixed (byte* ps = s) {
                    C0 = (uint) pS[r0 & 255] ^ (((uint) pS[(r1 >> 8) & 255]) << 8) ^
                         (((uint) ps[(r2 >> 16) & 255]) << 16) ^ (((uint) ps[(r3 >> 24) & 255]) << 24) ^ pkw[0];
                    C1 = (uint) ps[r1 & 255] ^ (((uint) pS[(r2 >> 8) & 255]) << 8) ^
                         (((uint) pS[(r3 >> 16) & 255]) << 16) ^ (((uint) ps[(r0 >> 24) & 255]) << 24) ^ pkw[1];
                    C2 = (uint) ps[r2 & 255] ^ (((uint) pS[(r3 >> 8) & 255]) << 8) ^
                         (((uint) pS[(r0 >> 16) & 255]) << 16) ^ (((uint) pS[(r1 >> 24) & 255]) << 24) ^ pkw[2];
                    C3 = (uint) ps[r3 & 255] ^ (((uint) ps[(r0 >> 8) & 255]) << 8) ^
                         (((uint) ps[(r1 >> 16) & 255]) << 16) ^ (((uint) pS[(r2 >> 24) & 255]) << 24) ^ pkw[3];
                }
                ...
                fixed (uint* pTinv0 = Tinv0) {
                    while (r > 1) {
                        kw = WorkingKey[r--];
                        fixed (uint* pkw = kw) {
                            tmp1 = pTinv0[(r3 >> 8) & 255];
                            tmp2 = pTinv0[(t2 >> 16) & 255];
                            tmp3 = pTinv0[(t1 >> 24) & 255];
                            shift1 = (tmp1 >> 24) | (tmp1 << 8);
                            shift2 = (tmp2 >> 16) | (tmp2 << 16);
                            shift3 = (tmp3 >> 8) | (tmp3 << 24);
                            r0 = pTinv0[t0 & 255] ^ shift1 ^ shift2 ^ shift3 ^ pkw[0];

                            tmp1 = pTinv0[(t0 >> 8) & 255];
                            tmp2 = pTinv0[(r3 >> 16) & 255];
                            tmp3 = pTinv0[(t2 >> 24) & 255];
                            shift1 = (tmp1 >> 24) | (tmp1 << 8);
                            shift2 = (tmp2 >> 16) | (tmp2 << 16);
                            shift3 = (tmp3 >> 8) | (tmp3 << 24);
                            r1 = pTinv0[t1 & 255] ^ shift1 ^ shift2 ^ shift3 ^ pkw[1];

                            tmp1 = pTinv0[(t1 >> 8) & 255];
                            tmp2 = pTinv0[(t0 >> 16) & 255];
                            tmp3 = pTinv0[(r3 >> 24) & 255];
                            shift1 = (tmp1 >> 24) | (tmp1 << 8);
                            shift2 = (tmp2 >> 16) | (tmp2 << 16);
                            shift3 = (tmp3 >> 8) | (tmp3 << 24);
                            r2 = pTinv0[t2 & 255] ^ shift1 ^ shift2 ^ shift3 ^ pkw[2];

                            tmp1 = pTinv0[(t2 >> 8) & 255];
                            tmp2 = pTinv0[(t1 >> 16) & 255];
                            tmp3 = pTinv0[(t0 >> 24) & 255];
                            shift1 = (tmp1 >> 24) | (tmp1 << 8);
                            shift2 = (tmp2 >> 16) | (tmp2 << 16);
                            shift3 = (tmp3 >> 8) | (tmp3 << 24);
                        ...
                        fixed (uint* pkw = kw) {
                            tmp1 = pTinv0[(r3 >> 8) & 255];
                            tmp2 = pTinv0[(r2 >> 16) & 255];
                            tmp3 = pTinv0[(r1 >> 24) & 255];
                            shift1 = (tmp1 >> 24) | (tmp1 << 8);
                            shift2 = (tmp2 >> 16) | (tmp2 << 16);
                            shift3 = (tmp3 >> 8) | (tmp3 << 24);
                            t0 = pTinv0[r0 & 255] ^ shift1 ^ shift2 ^ shift3 ^ pkw[0];

                            tmp1 = pTinv0[(r0 >> 8) & 255];
                            tmp2 = pTinv0[(r3 >> 16) & 255];
                            tmp3 = pTinv0[(r2 >> 24) & 255];
                            shift1 = (tmp1 >> 24) | (tmp1 << 8);
                            shift2 = (tmp2 >> 16) | (tmp2 << 16);
                            shift3 = (tmp3 >> 8) | (tmp3 << 24);
                            t1 = pTinv0[r1 & 255] ^ shift1 ^ shift2 ^ shift3 ^ pkw[1];

                            tmp1 = pTinv0[(r1 >> 8) & 255];
                            tmp2 = pTinv0[(r0 >> 16) & 255];
                            tmp3 = pTinv0[(r3 >> 24) & 255];
                            shift1 = (tmp1 >> 24) | (tmp1 << 8);
                            shift2 = (tmp2 >> 16) | (tmp2 << 16);
                            shift3 = (tmp3 >> 8) | (tmp3 << 24);
                            ...
                            tmp1 = pTinv0[(r2 >> 8) & 255];
                            tmp2 = pTinv0[(r1 >> 16) & 255];
                            tmp3 = pTinv0[(r0 >> 24) & 255];
                            shift1 = (tmp1 >> 24) | (tmp1 << 8);
                            shift2 = (tmp2 >> 16) | (tmp2 << 16);
                            shift3 = (tmp3 >> 8) | (tmp3 << 24);
                            r3 = pTinv0[r3 & 255] ^ shift1 ^ shift2 ^ shift3 ^ pkw[3];
                ...
                fixed (byte* pSi = Si)
                fixed (byte* ps = s) {
                    C0 = (uint) pSi[r0 & 255] ^ (((uint) ps[(r3 >> 8) & 255]) << 8) ^
                         (((uint) ps[(r2 >> 16) & 255]) << 16) ^ (((uint) pSi[(r1 >> 24) & 255]) << 24) ^ pkw[0];
                    C1 = (uint) ps[r1 & 255] ^ (((uint) ps[(r0 >> 8) & 255]) << 8) ^
                         (((uint) pSi[(r3 >> 16) & 255]) << 16) ^ (((uint) ps[(r2 >> 24) & 255]) << 24) ^ pkw[1];
                    C2 = (uint) ps[r2 & 255] ^ (((uint) pSi[(r1 >> 8) & 255]) << 8) ^
                         (((uint) pSi[(r0 >> 16) & 255]) << 16) ^ (((uint) ps[(r3 >> 24) & 255]) << 24) ^ pkw[2];
                    C3 = (uint) pSi[r3 & 255] ^ (((uint) ps[(r2 >> 8) & 255]) << 8) ^
                         (((uint) ps[(r1 >> 16) & 255]) << 16) ^ (((uint) ps[(r0 >> 24) & 255]) << 24) ^ pkw[3];
                }
        ...
        private void DecryptBlock(ReadOnlySpan<byte> input, Span<byte> output, uint[][] KW) {
            ...
            kw = KW[0];
            C0 = (uint) Si[r0 & 255] ^ (((uint) s[(r3 >> 8) & 255]) << 8) ^ (((uint) s[(r2 >> 16) & 255]) << 16) ^
                 (((uint) Si[(r1 >> 24) & 255]) << 24) ^ kw[0];
            C1 = (uint) s[r1 & 255] ^ (((uint) s[(r0 >> 8) & 255]) << 8) ^ (((uint) Si[(r3 >> 16) & 255]) << 16) ^
                 (((uint) s[(r2 >> 24) & 255]) << 24) ^ kw[1];
            C2 = (uint) s[r2 & 255] ^ (((uint) Si[(r1 >> 8) & 255]) << 8) ^ (((uint) Si[(r0 >> 16) & 255]) << 16) ^
                 (((uint) s[(r3 >> 24) & 255]) << 24) ^ kw[2];
            C3 = (uint) Si[r3 & 255] ^ (((uint) s[(r2 >> 8) & 255]) << 8) ^ (((uint) s[(r1 >> 16) & 255]) << 16) ^
        ...
        private void DecryptBlock(byte[] input, int inOff, byte[] output, int outOff, uint[][] KW)
        {
            ...
            while (r > 1)
            {
                kw = KW[r--];
                r0 =
 Tinv0[t0 & 255] ^ Shift(Tinv0[(r3 >> 8) & 255], 24) ^ Shift(Tinv0[(t2 >> 16) & 255], 16) ^ Shift(Tinv0[(t1 >> 24) & 255], 8) ^ kw[0];
                r1 =
 Tinv0[t1 & 255] ^ Shift(Tinv0[(t0 >> 8) & 255], 24) ^ Shift(Tinv0[(r3 >> 16) & 255], 16) ^ Shift(Tinv0[(t2 >> 24) & 255], 8) ^ kw[1];
                r2 =
 Tinv0[t2 & 255] ^ Shift(Tinv0[(t1 >> 8) & 255], 24) ^ Shift(Tinv0[(t0 >> 16) & 255], 16) ^ Shift(Tinv0[(r3 >> 24) & 255], 8) ^ kw[2];
                r3 =
 Tinv0[r3 & 255] ^ Shift(Tinv0[(t2 >> 8) & 255], 24) ^ Shift(Tinv0[(t1 >> 16) & 255], 16) ^ Shift(Tinv0[(t0 >> 24) & 255], 8) ^ kw[3];
                kw = KW[r--];
                t0 =
 Tinv0[r0 & 255] ^ Shift(Tinv0[(r3 >> 8) & 255], 24) ^ Shift(Tinv0[(r2 >> 16) & 255], 16) ^ Shift(Tinv0[(r1 >> 24) & 255], 8) ^ kw[0];
                t1 =
 Tinv0[r1 & 255] ^ Shift(Tinv0[(r0 >> 8) & 255], 24) ^ Shift(Tinv0[(r3 >> 16) & 255], 16) ^ Shift(Tinv0[(r2 >> 24) & 255], 8) ^ kw[1];
                t2 =
 Tinv0[r2 & 255] ^ Shift(Tinv0[(r1 >> 8) & 255], 24) ^ Shift(Tinv0[(r0 >> 16) & 255], 16) ^ Shift(Tinv0[(r3 >> 24) & 255], 8) ^ kw[2];
                r3 =
 Tinv0[r3 & 255] ^ Shift(Tinv0[(r2 >> 8) & 255], 24) ^ Shift(Tinv0[(r1 >> 16) & 255], 16) ^ Shift(Tinv0[(r0 >> 24) & 255], 8) ^ kw[3];
            }
 ...
 Tinv0[r3 & 255] ^ Shift(Tinv0[(t2 >> 8) & 255], 24) ^ Shift(Tinv0[(t1 >> 16) & 255], 16) ^ Shift(Tinv0[(t0 >> 24) & 255], 8) ^ kw[3];
            ...
            kw = KW[0];
            C0 =
 (uint)Si[r0 & 255] ^ (((uint)s[(r3 >> 8) & 255]) << 8) ^ (((uint)s[(r2 >> 16) & 255]) << 16) ^ (((uint)Si[(r1 >> 24) & 255]) << 24) ^ kw[0];
            C1 =
 (uint)s[r1 & 255] ^ (((uint)s[(r0 >> 8) & 255]) << 8) ^ (((uint)Si[(r3 >> 16) & 255]) << 16) ^ (((uint)s[(r2 >> 24) & 255]) << 24) ^ kw[1];
            C2 =
 (uint)s[r2 & 255] ^ (((uint)Si[(r1 >> 8) & 255]) << 8) ^ (((uint)Si[(r0 >> 16) & 255]) << 16) ^ (((uint)s[(r3 >> 24) & 255]) << 24) ^ kw[2];
            C3 =
 (uint)Si[r3 & 255] ^ (((uint)s[(r2 >> 8) & 255]) << 8) ^ (((uint)s[(r1 >> 16) & 255]) << 16) ^ (((uint)s[(r0 >> 24) & 255]) << 24) ^ kw[3];
