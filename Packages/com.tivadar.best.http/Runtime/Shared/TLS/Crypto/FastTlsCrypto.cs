        ...
        public override TlsCipher CreateCipher(TlsCryptoParameters cryptoParams, int encryptionAlgorithm,
            ...
            switch (encryptionAlgorithm) {
                case EncryptionAlgorithm.CHACHA20_POLY1305: {
                    ...
                    return new TlsAeadCipher(cryptoParams, encrypt, decrypt, 32, 16,
                ...
                case EncryptionAlgorithm.SM4_CBC: {
                    ...
                    FastTlsBlockCipherImpl encrypt =
                        new FastTlsBlockCipherImpl(CreateCbcBlockCipher(encryptionAlgorithm), true);
                    FastTlsBlockCipherImpl decrypt =
                        new FastTlsBlockCipherImpl(CreateCbcBlockCipher(encryptionAlgorithm), false);
