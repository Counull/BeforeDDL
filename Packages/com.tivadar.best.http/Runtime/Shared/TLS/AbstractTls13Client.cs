...
namespace Best.HTTP.Shared.TLS {
    public abstract class AbstractTls13Client : AbstractTlsClient, TlsAuthentication {
        ...
        protected AbstractTls13Client(List<ServerName> sniServerNames, List<ProtocolName> protocols, TlsCrypto crypto,
        ...
        public override void NotifySecureRenegotiation(bool secureRenegotiation) {
            HTTPManager.Logger.Information(nameof(AbstractTls13Client),
                $"{nameof(NotifySecureRenegotiation)}({secureRenegotiation})", this.Context);
