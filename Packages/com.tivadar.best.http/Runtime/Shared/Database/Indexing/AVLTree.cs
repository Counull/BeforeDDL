...
namespace Best.HTTP.Shared.Databases.Indexing {
    ...
    public struct NoAllocList<T> {
        ...
        public int Count {
            get => this._values != null ? this._values.Count : (this._hasValue ? 1 : 0);
        }
    ...
    public sealed class Node<KeyT, ValueT> {
        ...
        public int BalanceFactor {
            get { return this.LeftDepth - this.RightDepth; }
        }
        ...
        public int LeftDepth {
            get { return this.Left == null ? -1 : this.Left.Depth; }
        }
        ...
        public int RightDepth {
            get { return this.Right == null ? -1 : this.Right.Depth; }
        }
        ...
        public ValueT this[int index] {
            get => this._item[index];
        }

        public int Count {
            get => this._item.Count;
        }
