...
namespace Best.HTTP.Shared.Logger {
    ...
    public sealed class LoggingContext {
        ...
        public void Add(string key, long value) => Add(new LoggingContextField
            {fieldType = LoggingContextFieldType.Long, key = key, longValue = value});
        ...
        public void Add(string key, bool value) => Add(new LoggingContextField
            {fieldType = LoggingContextFieldType.Bool, key = key, boolValue = value});
        ...
        public void Add(string key, string value) => Add(new LoggingContextField
            {fieldType = LoggingContextFieldType.String, key = key, stringValue = value});
        ...
        public void Add(string key, LoggingContext value) => Add(new LoggingContextField
            {fieldType = LoggingContextFieldType.AnotherContext, key = key, loggingContextValue = value});
        ...
        public string GetStringField(string fieldName) =>
            this.fields.FirstOrDefault(f => f.key == fieldName).stringValue;
        ...
        public static string Escape(string original) {
            return Best.HTTP.Shared.PlatformSupport.Text.StringBuilderPool.ReleaseAndGrab(Best.HTTP.Shared
                .PlatformSupport.Text.StringBuilderPool.Get(1)
                .Append(original)
                .Replace("\\", "\\\\")
                .Replace("\"", "\\\"")
                .Replace("/", "\\/")
