...
namespace Best.HTTP.Shared.Extensions {
    public static class Extensions {
        ...
        public static Dictionary<string, List<string>> AddHeader(this Dictionary<string, List<string>> headers,
        ...
        public static Dictionary<string, List<string>> SetHeader(this Dictionary<string, List<string>> headers,
            string name, string value) {
            if (headers == null)
                headers = new Dictionary<string, List<string>>(StringComparer.OrdinalIgnoreCase);
        ...
        public static bool RemoveHeader(this Dictionary<string, List<string>> headers, string name) =>
            headers != null && headers.Remove(name);
        ...
        public static bool HasHeaderWithValue(this Dictionary<string, List<string>> headers, string headerName,
            string value) {
        ...
        public static uint ToUInt32(this string str, uint defaultValue = default) =>
            uint.TryParse(str, out var value) ? value : defaultValue;

        public static long ToInt64(this string str, long defaultValue = default(long)) =>
            long.TryParse(str, out var value) ? value : defaultValue;

        public static ulong ToUInt64(this string str, ulong defaultValue = default(ulong)) =>
            ulong.TryParse(str, out var value) ? value : defaultValue;
