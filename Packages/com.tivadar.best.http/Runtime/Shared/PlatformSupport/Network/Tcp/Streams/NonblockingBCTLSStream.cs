...
namespace Best.HTTP.Shared.PlatformSupport.Network.Tcp.Streams {
    public sealed class NonblockingBCTLSStream : PeekableContentProviderStream, ITCPStreamerContentConsumer {
        ...
        public NonblockingBCTLSStream(TCPStreamer streamer, TlsClientProtocol tlsClientProtocol,
            AbstractTls13Client tlsClient, bool disposeStreamer, uint maxBufferSize) {
        ...
        bool CallOnNegotiated(Exception error) {
            ...
            if (callback != null) {
                try {
                    ...
                    HTTPManager.Logger.Exception(nameof(NonblockingBCTLSStream), "CallOnNegotiated", ex,
