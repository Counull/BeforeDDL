...
namespace Best.HTTP.Shared.PlatformSupport.Network.DNS.Cache {
    ...
    internal class DNSCacheEntry {
        ...
        public DateTime LastUsed {
            get => new DateTime(this._lastUsedTicks);
        }
        ...
        public DNSCacheEntry DeriveWith(List<DNSIPAddress> resolvedAddresses) =>
            new DNSCacheEntry(this.Key, this.Host, this._lastUsedTicks, resolvedAddresses);
        ...
        /// </remarks>
        public bool IsStalled(DateTime now) => Volatile.Read(ref this._isRefreshing) == 0 &&
                                               this.ResolvedAt + DNSCache.Options.RefreshAfter < now;
