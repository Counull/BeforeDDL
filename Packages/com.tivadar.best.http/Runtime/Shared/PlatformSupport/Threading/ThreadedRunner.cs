...
namespace Best.HTTP.Shared.PlatformSupport.Threading {
    ...
    public static class ThreadedRunner {
        public static int ShortLivingThreads {
            get => _shortLivingThreads;
        }

        private static int _shortLivingThreads;

        public static int LongLivingThreads {
            get => _LongLivingThreads;
        }
        ...
        public static void RunShortLiving<T1, T2, T3, T4>(Action<T1, T2, T3, T4> job, T1 param1, T2 param2, T3 param3,
            T4 param4) {
            ThreadPool.QueueUserWorkItem(new WaitCallback(_ => {
                using var __ = new IncDecShortLiving(true);
